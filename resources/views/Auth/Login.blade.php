...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .background-svg {
                ...
                opacity: 1;
                z-index: -2;
                pointer-events: none; /* Ensures that the SVG doesn't interfere with form inputs */
                background-image: url('{{ asset('assets/images/edu_bg.svg') }}');
    ...
    <body class="gradient-bg">
        ...
        <div class="relative m-2 w-full max-w-md rounded-lg bg-blue-600 px-10 pb-14 pt-12 shadow-md">
            <span class="absolute right-3 top-6 rotate-12">
                <svg
                    fill="#ffffff"
                    width="44px"
                    height="44px"
            ...
            <div class="">
                <h2 class="mb-6 text-center text-3xl font-semibold text-white">Login</h2>
                <form action="{{ route('login-user') }}">
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                id="username"
                                name="name"
                                class="form-input mt-1 block w-full rounded-md p-3.5 pl-10 placeholder:text-xs"
                                placeholder="Enter your Id or email or Phone Number"
                            />
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                id="password"
                                name="password"
                                class="form-input mt-1 block w-full rounded-md p-3.5 pl-10 pr-5 placeholder:text-xs"
                    ...
                    <button
                        type="submit"
                        class="focus:shadow-outline w-full rounded bg-blue-500 px-4 py-3.5 font-semibold text-white hover:bg-blue-700 focus:outline-none"
                    >
                        Login
                    </button>
                </form>
