...
@section('Dashboard')
    ...
    <div class="flex justify-center">
        <div class="rounded-md border-2 border-gray-300 bg-blue-200 p-6 px-10  max-w-xl">
            <form action="{{ route('downloadAdmitCard', $school_code) }}" method="POST">
                @csrf

                <div class="grid grid-cols-4 mt-10 mb-6  mx-10">

                    <p for="classess" class="col-span-1 block w-[200px] mb-2 text-lg font-medium text-gray-900 ">Class Name
                    </p>
                    <p for="classess" class="col-span-1 block w-[200px] mb-2 text-lg font-medium text-gray-900 ">:</p>
                ...
                <div class="grid grid-cols-4 mb-5 mx-10">
                    ...
                    <p for="phone" class="col-span-1  block mb-2 w-[200px] text-lg font-medium text-gray-900 ">Group</p>
                    <p for="phone" class="col-span-1  block mb-2 w-[200px] text-lg font-medium text-gray-900 ">:</p>
                ...
                <div class=" grid grid-cols-4 mb-5  mx-10">
                    ...
                    <p for="last_name" class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900">Section</p>
                    <p for="last_name" class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900">:</p>
                ...
                <div class="grid grid-cols-4 mb-5  mx-10">
                    ...
                    <p for="last_name" class="col-span-1 mb-2 w-[200px] block text-lg font-medium text-gray-900">Student
                        ID</p>
                ...
                <div class="grid grid-cols-4 mb-5  mx-10">
                    ...
                    <p for="last_name" class="col-span-1 mb-2 w-[200px] block text-lg font-medium text-gray-900">Exam Name
                    </p>
                    <p for="last_name" class="col-span-1 mb-2 w-[200px] block text-lg font-medium text-gray-900">:</p>
                ...
                <div class=" grid grid-cols-4 mb-5  mx-10">
                    ...
                    <p for="last_name" class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900">Year</p>
                    <p for="last_name" class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900"> :</p>
                ...
                <div class="grid grid-cols-4 mb-5  mx-10">
                    <label for="last_name" class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900">Print
                        Type:</label>
                    <label for="last_name"
                        class="col-span-1 mb-2 block w-[200px] text-lg font-medium text-gray-900">:</label>
                    ...
                    <button type="submit"
                        ...
                        <span>
                            <svg fill="#ffffff" height="20px" width="20px" version="1.1" id="Capa_1"
                                ...
                                viewBox="0 0 60 60" xml:space="preserve" stroke="#ffffff">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <g>
