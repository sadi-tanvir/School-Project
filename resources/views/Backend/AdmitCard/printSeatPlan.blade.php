...
<div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
    <h2 class="">Print Seat Plan | Student Admin Card</h2>
...
<div class="">
    <div class="rounded-md border-2 border-gray-300 bg-gray-200 p-6">
        <form action="{{ route('downloadPrint', $school_code) }}" method="POST">
            @csrf
            <div class="mb-5">
                <div class=" ">
            ...
            <div class="mb-5">
                <div class=" ">
                    <label for="last_name" class="mb-2 block text-sm font-medium text-gray-900">Group:</label>
                </div>
                <div class="">
