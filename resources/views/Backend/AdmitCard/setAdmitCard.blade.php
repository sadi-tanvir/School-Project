...
<script>
    function submitForm() {
        var className = document.getElementById('class_name') ? document.getElementById('class_name').value : '';
        var groupName = document.getElementById('group_name') ? document.getElementById('group_name').value : ''; // Corrected id
        var classExamName = document.getElementById('class_exam_name') ? document.getElementById('class_exam_name').value : '';
        var academicYearName = document.getElementById('year') ? document.getElementById('year').value : '';
