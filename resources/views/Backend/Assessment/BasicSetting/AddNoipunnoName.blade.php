...
@section('Dashboard')
    <div class="my-5">
        <h1 class="text-xl font-semibold">পারদর্শিতার সূচক নৈপুণ্য</h1>
    </div>
    ...
    <div class="w-full border mx-auto p-5 space-y-10">
        <form action="{{ url('') }}" method="POST">
            ...
            <div class="grid grid-cols-6 items-center  gap-5">
                ...
                <div>
                    <button type="submit"
                        class="text-white bg-gradient-to-br from-sky-600 to-sky-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center uppercase">
                        New Add
                    </button>
                </div>
            </div>
