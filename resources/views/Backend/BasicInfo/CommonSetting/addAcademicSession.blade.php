        ...
        <div class="flex items-center justify-end">
            ...
            >
                <div class="relative max-h-full w-full max-w-md p-4">
                    <!-- Modal content -->
                    <div class="dd relative rounded-lg bg-white shadow">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW SESSION ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addAcademicSession', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                <div class="hidden">
                                    ...
                                    <input
                                        ...
                                        name="school_code"
                                        id="last_name"
                                        class="dd d block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
