...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-md">
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW YEAR ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addAcademicYear', $school_code) }}"
                                method="POST"
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="bg-blue-600 p-6 text-sm text-white">
                <tr>
