                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW Board Exam Name ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addBoardExam', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                @method('PUT')
                                <div>
                                    <label for="board_exam_name" class="mb-2 block text-sm font-medium text-gray-900">
                                        Board Exam Name :
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div class="flex justify-center">
                                    <button
                                        type="submit"
                                        class="mr-5 bg-blue-700 text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
                                    >
                                        Save
                                    </button>
                                    <button
