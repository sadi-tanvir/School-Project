...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Class / Class Information</h2>
    ...
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-lg">
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW CLASS ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addClass', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                @method('PUT')
                                <div>
                                    <label for="class_name" class="mb-2 block text-sm font-medium text-gray-900">
                                        Class Name :
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div class="flex justify-center">
                                    ...
                                    <button
                                        type="button"
                                        data-modal-hide="authentication-modal"
                                        class="end-2.5 rounded-lg bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300"
                                    >
                                        Close
                                    </button>
                                </div>
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="text- rounded-md border-blue-400 bg-blue-600 font-normal text-white">
                <tr>
            ...
            <tbody>
                @foreach ($classData as $key => $data)
                    <tr class="border-b text-sm capitalize">
                        ...
                        <td class="flex justify-start px-6 py-4 text-xl">
