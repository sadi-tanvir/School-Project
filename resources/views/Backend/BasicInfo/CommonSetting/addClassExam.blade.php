            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="p-4 md:p-5">
                        <form action="{{ url('dashboard/addClassExam',$school_code) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="class_exam_name" class="block mb-2 text-sm font-medium text-gray-900 "> Exam Name :</label>
                                <input type="text" name="class_exam_name" id="class_exam_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  " placeholder="enter class exam name" required />
                            </div>
                            ...
                            <div class="flex justify-center ">
                                ...
                                <button type="button" data-modal-hide="authentication-modal" class="end-2.5  text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center d ">Close</button>
