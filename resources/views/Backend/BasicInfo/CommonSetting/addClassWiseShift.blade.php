...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Class Setting/Shift</h2>
    ...
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-md">
            ...
            <div class="my-10">
                ...
                <div class="mt-6">
                    <div class="mb-6 grid items-center gap-6 rounded border border-gray-200 py-5 ps-4 md:grid-cols-3">
                        @foreach ($shiftData as $data)
                            <div>
                                <input
                                    id="shift_{{ $data->shift_name }}"
                                    type="checkbox"
                                    value="{{ $data->shift_name }}"
                                    name="shift_name"
                                    class="shift-checkbox h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500"
                                />
                                <label
                                    for="shift_{{ $data->shift_name }}"
                ...
                <div class="text-end">
                    <button
                        type="button"
                        onclick="getData()"
                        class="w-full rounded-md bg-blue-700 px-7 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                    >
                        Get Data
                    </button>
                </div>
        ...
        <div class="flex justify-center pb-6 text-lg font-semibold">
            <h3>Class Wise Shift Setting</h3>
        </div>
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="border-b border-blue-400 bg-blue-600 text-xs uppercase text-white">
                <tr>
                    ...
                    <th scope="col" class="bg-blue-500 px-6 py-3">Shift Name</th>
        ...
        <div class="mr-32 flex justify-end">
