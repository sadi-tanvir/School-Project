            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="p-4 md:p-5">
                        <form action="{{ url('dashboard/addGroup',$school_code) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="group_name" class="block mb-2 text-sm font-medium text-gray-900 "> Group Name :</label>
                                <input type="text" name="group_name" id="group_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="enter group name" required />
                            </div>
                            ...
                            <div class="flex justify-center ">
                                <button type="submit" class=" mr-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center d">Save</button>
        ...
        <tbody>
            ...
            <tr class=" border-b capitalize text-lg">
                ...
                <td class="px-6 py-4  text-xl flex justify-center">
                    ...
                    <form method="POST" action="{{ url('dashboard/delete_group', $data->id) }}">
                        @csrf
                        @method('DELETE')
                        <button class="btn ">
