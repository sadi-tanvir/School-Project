...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Shift/Shift Information</h2>
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW CLASS PERIOD ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addPeriod', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                @method('PUT')
                                <div>
                                    <label for="class_period" class="mb-2 block text-sm font-medium text-gray-900">
                                        Class Period Name :
                                    </label>
                                    <input
                                        type="text"
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="bg-blue-600 text-sm text-white">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Class Period</th>
            ...
            <tbody>
                @foreach ($periodData as $key => $data)
                    <tr class="capialize border-b text-sm">
