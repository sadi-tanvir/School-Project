                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW SHIFT ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addShift', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                @method('PUT')
                                <div>
                                    <label for="shift_name" class="mb-2 block text-sm font-medium text-gray-900">
                                        Shift Name :
                                    </label>
                                    <input
                                        type="text"
