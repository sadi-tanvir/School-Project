            ...
            <div class="grid md:grid-cols-3 mb-5">
                ...
                <div class="">
                    <input type="text" name="institute_code" id="institute_code"
                        ...
                        placeholder="Enter The Institute Code" required />
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
                ...
                <div class="">
                    <input type="text" name="eiin" id="eiin"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Enter The EIIN No" required />
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 mb-5">
                ...
                <div class="">
                    <input type="text" name="institute_name" id="institute_name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Enter The Institute Name " required />
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
                ...
                <div class="">
                    <input type="text" name="address1" id="address1"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Enter The Address1" required />
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
                ...
                <div class="">
                    <input type="text" name="address2" id="address2"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Enter The Address2" required />
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
            ...
            <div class="grid md:grid-cols-3 mb-5">
                ...
                <div class="">
                    <input type="text" name="fax" id="fax"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Enter The Fax" required />
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
