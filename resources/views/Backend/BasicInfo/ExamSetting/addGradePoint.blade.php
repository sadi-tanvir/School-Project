                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW GRADE POINT ENTRY FORM</h3>
                            <button type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form action="{{ url('dashboard/addGradePoint', $school_code) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div>
                                    <label for="mark_point_1st" class="mb-2 block text-sm font-medium text-gray-900">
                                        Mark Point 1st :
                                    </label>
                                    <input type="text" name="mark_point_1st" id="mark_point_1st"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                                        placeholder="Make 1st Point" required />
                                </div>
                                <div>
                                    <label for="mark_point_2nd" class="mb-2 block text-sm font-medium text-gray-900">
                                        Mark Point 2nd :
                                    </label>
                                    <input type="text" name="mark_point_2nd" id="mark_point_2nd"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                                        placeholder="Make 2nd Point" required />
                                </div>
                                <div>
                                    <label for="grade_point" class="mb-2 block text-sm font-medium text-gray-900">
                                        Grade Point :
                                    </label>
                                    <input type="text" name="grade_point" id="grade_point"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                                        placeholder="Grade Point" required />
                                </div>
                                <div>
                                    <label for="letter_grade" class="mb-2 block text-sm font-medium text-gray-900">
                                        Letter Grade :
                                    </label>
                                    <input type="text" name="letter_grade" id="letter_grade"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                                        placeholder="Letter Grade" required />
                                </div>
                                <div>
                                    <label for="note" class="mb-2 block text-sm font-medium text-gray-900">
                                        Note :
                                    </label>
            ...
            <div id="update-modal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-lg bg-white shadow">
                        <!-- Modal header -->
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">Update GRADE POINT ENTRY FORM</h3>
                            <button type="button"
                                class="end-2.5 ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900"
                        ...
                        <!-- Modal body -->
                        <div class="p-4 md:p-5">
                            <form action="{{ route('edit_grade_point', $school_code) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="bg-blue-600 text-sm text-white">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Mark Interval</th>
                    <th scope="col" class="bg-blue-500 px-6 py-3">Grade Point</th>
                    <th scope="col" class="px-6 py-3">Letter Grade</th>
                    <th scope="col" class="bg-blue-500 px-6 py-3">Note</th>
            ...
            <tbody>
                @foreach ($gradePointData as $key => $data)
                    <tr class="border-b text-sm">
                        ...
                        <td class="px-6 py-4">{{ $data->mark_point_1st }}-{{ $data->mark_point_2nd }}</td>
                        <td class="px-6 py-4">
                            {{ $data->grade_point }}
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="flex px-6 py-4 text-xl">
                            ...
                            <a class="edit-button mr-2" data-id="{{ $data->id }}" data-modal-target="update-modal" data-modal-toggle="update-modal">
