            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="p-4 md:p-5">
                        <form action="{{ url('dashboard/addGradePoint',$school_code) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="mark_point_1st" class="block mb-2 text-sm font-medium text-gray-900 ">Mark Point 1st
                                    :</label>
                                <input type="text" name="mark_point_1st" id="mark_point_1st" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="Make 1st Point" required />
                            </div>
                            <div>
                                <label for="mark_point_2nd" class="block mb-2 text-sm font-medium text-gray-900 ">Mark Point 2nd
                                    :</label>
                                <input type="text" name="mark_point_2nd" id="mark_point_2nd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="Make 2nd Point" required />
                            </div>
                            <div>
                                <label for="grade_point" class="block mb-2 text-sm font-medium text-gray-900 ">Grade Point
                                    :</label>
                                <input type="text" name="grade_point" id="grade_point" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="Grade Point" required />
                            </div>
                            <div>
                                <label for="letter_grade" class="block mb-2 text-sm font-medium text-gray-900 ">Letter Grade
                                    :</label>
                                <input type="text" name="letter_grade" id="letter_grade" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="Letter Grade" required />
                            </div>
                            <div>

                                <label for="note" class="block mb-2 text-sm font-medium text-gray-900 ">Note :</label>
                                <textarea name="note" id="note" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500     " placeholder="Write your thoughts here..."></textarea>
