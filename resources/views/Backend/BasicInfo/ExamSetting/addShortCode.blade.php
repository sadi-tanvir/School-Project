...
<div class="flex justify-center font-bold md:mx-32 my-5">
    <div>
        <h3>
            Make sure to fix the short code position before inputting the mark. Otherwise, if you change the short code position after inputting the mark, the mark will not appear correctly in the mark input and report. So fix the short code position first.
        </h3>
    </div>
</div>
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
    <div class="grid gap-6 mb-6 md:grid-cols-4 ">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow ">
                    ...
                    <div class="p-4 md:p-5">
                        <form action="{{ url('dashboard/addShortCode',$school_code) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div>
                                <label for="short_code" class="block mb-2 text-sm font-medium text-gray-900 ">Exam Short Code :
                                </label>
                                <input type="text" name="short_code" id="short_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="enter Exam Short Code" required />
                            </div>
                            <div>
        ...
        <div class="flex justify-end">
            <button type="button" class="  text-white bg-rose-700 hover:bg-rose-600 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2   focus:outline-none ">Print
            </button>
        </div>
    </div>
