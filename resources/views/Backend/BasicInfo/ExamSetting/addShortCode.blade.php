...
@section('Dashboard')
    ...
    <div class="pb-2">
        <div class="flex items-center gap-4">
            ...
            <h3 class="text-sm text-orange-700">
                Make sure to fix the short code position before inputting the mark. Otherwise, if you change the short
                code position after inputting the mark, the mark will not appear correctly in the mark input and report.
                So fix the short code position first.
            </h3>
        </div>
    </div>
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-md">
        <div class="flex items-center justify-end pb-4">
            <button
                data-modal-target="authentication-modal"
                data-modal-toggle="authentication-modal"
                type="button"
                class="btn-hover__new btn-hover mb-2 me-2 flex items-center gap-3 rounded-md bg-blue-700 px-4 py-3.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300"
            >
                <span>Add New</span>
                <span>
                ...
                <div class="relative max-h-full w-full max-w-md p-4">
                    ...
                    <div class="relative rounded-md bg-white shadow">
                        ...
                        <div class="flex items-center justify-between rounded-t border-b p-4 md:p-5">
                            <h3 class="text-lg font-semibold text-gray-900">NEW SHORT CODE ENTRY FORM</h3>
                            <button
                                type="button"
                        ...
                        <div class="p-4 md:p-5">
                            <form
                                action="{{ url('dashboard/addShortCode', $school_code) }}"
                                method="POST"
                            ...
                            >
                                ...
                                @method('PUT')
                                <div>
                                    <label for="short_code" class="mb-2 block text-sm font-medium text-gray-900">
                                        Exam Short Code :
                                    </label>
                                    <input
                                        type="text"
                                        ...
                                        placeholder="enter Exam Short Code"
                                        required
                                    />
                                </div>
                                <div>
                                ...
                                <div class="flex justify-center">
                                    <button
                                        type="submit"
                                        class="mr-5 rounded-md bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
                                    >
                                        Save
                                    </button>
                                    <button
                                        type="button"
                                        data-modal-hide="authentication-modal"
                                        class="end-2.5 rounded-md bg-red-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300"
                                    >
                                        Close
                                    </button>
                                </div>
            ...
            <div class="flex justify-end">
                <button
                    type="button"
                    class="btn-hover__new btn-hover mb-2 flex items-center gap-3 rounded-md border-2 border-blue-700 px-5 py-3 text-sm font-medium text-blue-800 hover:bg-blue-700 hover:text-white focus:outline-none focus:ring-4 focus:ring-red-300"
                >
                    <span>Print</span>
                    <span>
                        <svg
                        ...
                        >
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <g>
                                    <path
                                        fill="#0054AF"
                                        d="M32,7.5C32,6.673,31.327,6,30.5,6h-29C0.673,6,0,6.673,0,7.5v17C0,25.327,0.673,26,1.5,26h4 C5.776,26,6,25.776,6,25.5S5.776,25,5.5,25h-4C1.225,25,1,24.775,1,24.5v-17C1,7.225,1.225,7,1.5,7h29C30.775,7,31,7.225,31,7.5v17 c0,0.275-0.225,0.5-0.5,0.5h-4c-0.276,0-0.5,0.224-0.5,0.5s0.224,0.5,0.5,0.5h4c0.827,0,1.5-0.673,1.5-1.5V7.5z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M9,30.5v-10C9,20.224,8.776,20,8.5,20S8,20.224,8,20.5v10C8,31.327,8.673,32,9.5,32h13 c0.827,0,1.5-0.673,1.5-1.5v-10c0-0.276-0.224-0.5-0.5-0.5S23,20.224,23,20.5v10c0,0.275-0.225,0.5-0.5,0.5h-13 C9.225,31,9,30.775,9,30.5z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M3.5,10C3.224,10,3,10.224,3,10.5S3.224,11,3.5,11h2C5.776,11,6,10.776,6,10.5S5.776,10,5.5,10H3.5z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M9.5,10h-2C7.224,10,7,10.224,7,10.5S7.224,11,7.5,11h2c0.276,0,0.5-0.224,0.5-0.5S9.776,10,9.5,10z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M23.5,4C23.776,4,24,3.776,24,3.5v-2C24,0.673,23.327,0,22.5,0h-13C8.673,0,8,0.673,8,1.5v2 C8,3.776,8.224,4,8.5,4S9,3.776,9,3.5v-2C9,1.225,9.225,1,9.5,1h13C22.775,1,23,1.225,23,1.5v2C23,3.776,23.224,4,23.5,4z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M11,28h10c0.276,0,0.5-0.224,0.5-0.5S21.276,27,21,27H11c-0.276,0-0.5,0.224-0.5,0.5S10.724,28,11,28z"
                                    ></path>
                                    <path
                                        fill="#0054AF"
                                        d="M11,24h10c0.276,0,0.5-0.224,0.5-0.5S21.276,23,21,23H11c-0.276,0-0.5,0.224-0.5,0.5S10.724,24,11,24z"
                                    ></path>
                                </g>
                            </g>
                        </svg>
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="bg-blue-600 text-sm text-white">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Short Code</th>
                    <th scope="col" class="bg-blue-500 px-6 py-3">Mark Position</th>
                    <th scope="col" class="px-6 py-3">View Position</th>
                ...
                @foreach ($shortCodeData as $key => $data)
                    <tr class="border-b text-sm">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                                <span class="font-semibold text-red-800">Inactive</span>
                            @endif
                        </td>
