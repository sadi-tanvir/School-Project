...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-md">
        <div class="mb-6 grid gap-6 md:grid-cols-4">
            <a href="/dashboard/listSignature/{{ $school_code }}">
                <button
                    type="button"
                    class="mb-2 me-2 flex items-center gap-3 rounded-md bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 md:mr-20"
                >
                    <span>
                        <svg
                                ...
                                >
                                    <path
                                        style="
                                            ...
                                            stroke-opacity: 1;
                                        "
                                        d="m 22.873047,731.57017 0,22.36914 14.541015,0 0,79.21484 26.382813,0 0,-101.58398 -40.923828,0 z m 109.269533,38.29297 0,25 267.85742,0 0,-25 -267.85742,0 z m -85.187502,97.62695 c -7.807469,0 -14.62922,1.62334 -20.46289,4.86914 -5.877533,3.20194 -10.505425,7.7867 -13.882813,13.75196 -3.2458017,6.09684 -5.0004988,12.91663 -5.2636719,20.46093 l 29.1464849,0 c -0.307036,-1.35973 -0.458985,-2.78603 -0.458985,-4.27734 0,-3.68442 0.98714,-6.64389 2.960938,-8.88086 2.105385,-2.36856 4.802133,-3.55273 8.091797,-3.55273 3.465112,0 6.250084,1.35866 8.355468,4.07812 2.149248,2.67559 3.22461,5.72524 3.22461,9.14649 0,8.1145 -3.860334,16.42628 -11.580078,24.93554 l -41.4492192,45.13281 81.6484372,0 0,-22.36914 -33.291015,0 15.724609,-14.67187 c 3.026491,-2.80718 5.57129,-5.43825 7.632812,-7.89453 2.061523,-2.50014 3.705453,-4.8685 4.933594,-7.10547 2.587869,-4.69325 3.882813,-10.52787 3.882813,-17.50195 0,-5.35119 -1.032228,-10.28493 -3.09375,-14.80274 -2.19311,-4.78098 -4.978081,-8.59818 -8.355469,-11.44922 -3.596699,-3.07035 -7.762884,-5.50439 -12.5,-7.30273 -4.737116,-1.71063 -9.824761,-2.56641 -15.263672,-2.56641 z m 85.187502,40.33203 0,25 267.85742,0 0,-25 -267.85742,0 z"
                                        id="rect7055"
        ...
        <div class="">
            <form
                action="{{ url('dashboard/AddSignature', $school_code) }}"
                method="POST"
            ...
            >
                ...
                @method('PUT')
                <div>
                    <label for="Code" class="mb-2 block text-sm font-medium text-gray-900">Signature Name :</label>
                ...
                <div class="hidden">
                    <label for="last_name" class="mb-2 block text-sm font-medium text-gray-900">School Code</label>
                    <input
                        type="text"
                        value="{{ $school_code }}"
                        name="school_code"
                ...
                <div class="mt-5 flex justify-end">
                    <button
                        type="submit"
                        class="flex items-center gap-1 rounded-md bg-blue-700 py-2.5 pe-5 ps-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300"
                    >
                        <span>
                            <svg
                                width="24px"
