...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Exam Publish and Close</h2>
    ...
    <div class="">
        <div class="rounded-md border-2 p-6">
            <form
                class="space-y-3"
                action="{{ url('dashboard/addExamPublish', $school_code) }}"
                method="POST"
            ...
            >
                ...
                <div class="">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium text-gray-900">Class:</label>
                    </div>
                    <div class="">
                        <select
                            id="countries"
                ...
                <div class="">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium text-gray-900">Status :</label>
                    </div>
                    <div>
                        <select
                            name="status"
                ...
                <div class="flex justify-end">
                    <button
                        type="submit"
                        class="w-full rounded-lg bg-blue-700 px-8 py-3 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                    >
                        Publish
                    </button>
                </div>
            ...
            <div class="my-3 flex justify-end">
                <button
                    type=""
                    class="flex w-full items-center justify-center gap-3 rounded-lg border border-blue-700 bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                >
                    <span>
                        <svg
                            width="24px"
                    ...
                    <a href="{{ url('/dashboard/ViewExamPublish', $school_code) }}">View</a>
                </button>
            </div>
        </div>
    </div>
