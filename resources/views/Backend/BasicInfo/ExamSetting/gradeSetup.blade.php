...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto border-2 p-6 sm:rounded-lg">
        <form id="myForm" action="{{ route('addGradeSetup', $school_code) }}" method="POST">
            ...
            <div class="">
                <div class="mr-5">
                    <label for="session" class="mb-2 block text-sm font-medium text-gray-900">Exam Name :</label>
                </div>
                <div class="mt-2">
                    <select
                        id="class_exam_name"
        ...
        @if ($classExamName)
            <form class="" action="{{ route('saveGradeSetup', $school_code) }}" method="POST">
                @csrf
                ...
                <div class="mt-10 flex">
                    <div class="mt-7">
                        <div
                            class="mx-5 mb-6 grid items-center gap-5 rounded border border-blue-200 px-20 py-10 ps-4 md:grid-cols-1"
                        >
                            <h3>Select Class</h3>
                            @foreach ($classData as $data)
                                <div>
                                    @php
                                        $classChecked = $gradesetup
                                    ...
                                    @unless ($classChecked)
                                        <input
                                            id="group_{{ $data->class_name }}"
                                            type="checkbox"
                                            value="{{ $data->class_name }}"
                                            name="class_name[]"
                                            class="group-checkbox h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500"
                                            @if($classChecked) checked @endif
                                        />
                                    @endunless

                                    <label
                                        for="group_{{ $data->class_name }}"
                                        class="ms-2 w-full py-4 text-sm font-medium text-gray-900"
                                    >
                                        {{ $data->class_name }}
                                    </label>
                                </div>
                    ...
                    <div class="grow text-lg font-bold">
                        <div class="flex justify-center">
                            <h3>Exam Wise Grade Setting</h3>
                        </div>

                        <table class="w-full text-left text-sm text-black rtl:text-right">
                            <thead class="border-b border-blue-400 bg-blue-600 text-sm text-white">
                                <tr>
                                    <th scope="col" class="bg-blue-500 px-6 py-3">SL</th>
                                    <th scope="col" class="px-6 py-3">Letter</th>
                                    <th scope="col" class="bg-blue-500 px-6 py-3">Grade</th>
                                    <th scope="col" class="px-6 py-3">1st Range</th>
                                    <th scope="col" class="bg-blue-500 px-6 py-3">2nd Range</th>
                            ...
                            <tbody>
                                @foreach ($gradePointData as $key => $data)
                                    <tr class="border-b text-sm capitalize">
                                        <th scope="row" class="whitespace-nowrap px-6 py-4 text-black">
                                            {{ $key + 1 }}
                                        ...
                                        <td class="px-6 py-4">
                                            <!-- {{ $data->grade_point }} -->
                                            <input
                                                class="w-[80px] border-0"
                                                value="{{ $data->grade_point }}"
                                                name="grade_point[{{ $key }}]"
                                                type="text"
                                            />
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            <input
                                                class="w-[80px] border-0"
                                                value="{{ $data->mark_point_1st }}"
                                                name="mark_point_1st[{{ $key }}]"
                                                type="text"
                                            />
                                        </td>
                                        <td class="px-6 py-4">
                                            ...
                                            <input
                                                class="w-[80px] border-0"
                                                value="{{ $data->mark_point_2nd }}"
                                                name="mark_point_2nd[{{ $key }}]"
                                                type="text"
                                            />
                                        </td>
                                        <td class="px-6 py-4">
                                            <div>
                                                <select class="border-0" name="status[]" id="">
                ...
                <div class="justify-center md:flex">
                    <div class="mr-10">
                        <a
                            href="{{ route('viewGradeSetup', $school_code) }}"
                            class="w-full rounded-lg bg-blue-500 px-5 py-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                        >
                            GET Config View
                        </a>
                    </div>
                    <div class="mr-10">
                        <button
                            type="submit"
                            class="w-full rounded-lg bg-blue-700 px-5 py-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                        >
                            Save
                        </button>
                    </div>
                    <div class="mr-10">
                        <a
                            href="{{ route('dashboard.index', $school_code) }}"
                            class="w-full rounded-lg bg-red-700 px-5 py-3.5 text-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 sm:w-auto"
                        >
                            Close
                        </a>
                    </div>
        ...
        @else
            <div class="justify-center md:flex">
                <div class="mr-10">
                    <a
                        href="/dashboard/viewGradeSetup/{{ $school_code }}"
                        class="w-full rounded-lg bg-blue-500 px-5 py-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                    >
                        GET Config View
                    </a>
