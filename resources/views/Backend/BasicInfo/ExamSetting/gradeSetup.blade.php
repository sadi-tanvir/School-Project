            ...
            <div class="md:flex my-10 ">
                ...
                <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
                    ...
                    <span class="svg-top-rotate absolute -top-4 right-12 rotate-3 opacity-45">
                        <svg width="64px" height="64px" viewBox="0 0 48 48" id="Layer_1" version="1.1"
                                                    ...
                                                    <div
                                                        ...
                                                        @foreach($classData as $data)
                                                                                            <div>
                                                                                                ...
                                                                                                @endphp
                                                                                                @unless($classChecked)
                                                                                                    <input id="group_{{ $data->class_name }}" type="checkbox"
                                                        ...
                                                        <tbody>
                                                            @foreach($gradePointData as $key => $data)
                                                                <tr class=" border-b capitalize text-lg">
                                                                    ...
                                                                    <td class="px-6 py-4">
                                                                        {{$data->letter_grade}}
                                                                        <input class="hidden" value="{{$data->letter_grade}}"
                                                                            name="latter_grade[{{$key}}]" type="text">
                                                                    </td>
                                                                    <td class="px-6 py-4">
                                                                        <!-- {{$data->grade_point}} -->
