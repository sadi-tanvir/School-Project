...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Signature List Name</h2>
    ...
    <div class="relative overflow-x-auto border-2 p-6 shadow-md sm:rounded-lg">
        <div class="mb-6 grid gap-6 md:grid-cols-4">
            <a href="/dashboard/AddSignature/{{ $school_code }}">
                <button
                    type="button"
                    class="mb-2 me-2 rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 md:mr-20"
                >
                    Add New
                </button>
            </a>
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right">
            <thead class="bg-blue-600 text-sm text-white">
                <tr>
                    ...
                    <th scope="col" class="bg-blue-500 px-6 py-3">Signature</th>
