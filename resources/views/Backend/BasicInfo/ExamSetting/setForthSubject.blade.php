                        ...
                        @if($students)
                                                ...
                                                <div class="lg:w-[700px] mx-auto mt-5 border p-5 mb-5">
                                                    ...
                                                    <div class=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 ">
                                                        @foreach($data as $item)
                                                            <div class="flex items-center optional-subject">
                                                                <input id="{{ $item['id'] }}" type="checkbox" name="compulsory_subject"
                                                                    value="{{ $item['value'] }}"
                                                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500   focus:ring-2  ">
                                                                <label class="ms-2 text-sm font-medium text-gray-900 ">{{ $item['label'] }}</label>
                                                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function enableCompulsorySubjects() {
                                    ...
                                    @foreach($students as $index => $student)
                                        <tr class=" border-b border-blue-400">
                                            <th scope="row" class="px-6 py-4 font-medium text-black whitespace-nowrap ">
                                                <input id="bordered-checkbox-{{ $index }}" type="checkbox"
                                                    value="{{ $student->student_id }}" name="selected_students[]"
                                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500   focus:ring-2  "
                                            ...
                                            <input class="hidden" name="class_name" value="{{$student->Class_name}}"
                                                type="text">
                ...
                <div class="md:flex justify-center">
                    <div class="mr-10">
                        <a href="/dashboard/viewFourthSubject/{{$school_code}}">
                            <p
