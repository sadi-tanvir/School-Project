...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Update Mark Config View</h2>
    ...
    <div>
        <div class="mt-10">
            <h1 class="bg-blue-300 p-2 text-center text-xl font-semibold">Update Exam Mark Config Report</h1>
        </div>
    </div>
    ...
    <div class="border-2 p-6">
        <form action="{{ route('update-marks') }}" method="POST">
            ...
            <table class="w-full text-center text-sm text-black rtl:text-right">
                <thead class="border-b border-blue-400 bg-blue-600 text-xs uppercase text-white">
                    <tr>
                        ...
                        <th scope="col" class="bg-blue-500 px-6 py-3">Total Marks</th>
                        <th scope="col" class="px-6 py-3">Countable Marks</th>
                        <th scope="col" class="px-6 py-3">Pass Marks</th>
                        <th scope="col" class="px-6 py-3">Acceptance</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="mt-2">
                            <input
                                class="hidden w-[200px] rounded-xl"
                                name="short_code"
            ...
            <div class="mt-5 flex justify-end">
                ...
                <button type="submit" class="rounded-xl bg-blue-500 px-5 py-2 text-white hover:bg-blue-600">
                    Update Code
                </button>
            </div>
        </form>
