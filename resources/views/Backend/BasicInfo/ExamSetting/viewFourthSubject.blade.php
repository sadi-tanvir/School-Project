...
<style>
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Closable Subject List</h2>
...
<div class="relative overflow-x-auto sm:rounded-lg ">
    <form action="{{route('getFourthSubject')}}" method="post">
        ...
        <div class=" ">
            ...
            <div class="">
                <select id="countries" name="class_name" class="bg-white border-0  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div class="">
                <select id="countries" name="group_name" class="bg-white border-0  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div class="">
                <select id="countries" name="section_name" class="bg-white border-0  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div class="">
                <select name="year" id='date-dropdown' class="bg-white border-0  text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <tbody>
                ...
                <tr class=" border-b border-blue-400">
                    ...
                    <td class="px-6 py-4 flex">
                        <button class="text-xl font-bold text-green-500 "><i class="fa-solid fa-pen"></i></button>
