...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
    <form action="{{route('getFourthSubject')}}" method="post">
        ...
        <div class="grid md:grid-cols-9 gap-4 my-10 ">
            ...
            <div class="mr-2">
                <select id="countries" name="class_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div class="mr-2">
                <select id="countries" name="group_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div class="mr-2">
                <select name="year" id='date-dropdown' class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
