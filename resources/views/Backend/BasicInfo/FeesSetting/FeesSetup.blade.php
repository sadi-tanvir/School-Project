...
<div class="w-full border-2 rounded-md mx-auto p-6 space-y-10 border-gray-300 bg-gray-200">
    <form action="{{ route('feesSetup.FeeTypesData.view', $school_code) }}" method="post">
        ...
        <div class="grid grid-cols-4 items-center gap-6">
            ...
            <div>
                <button type="submit" class="text-white bg-gradient-to-br from-blue-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-7 py-3.5 text-center  mt-7">
                    Get Data
                </button>
            </div>
        </div>
        ...
        <div class="space-y-1">
            ...
            <div class="">
                ...
                <div class="w-full flex justify-end items-center gap-10 mt-10">
                    <button type="submit" class="text-white bg-gradient-to-br from-blue-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20 py-3.5 text-center">
                        Save
                    </button>
                </div>
            </div>
