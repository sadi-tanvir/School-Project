        ...
        <form class="grid grid-cols-3 gap-5" id="waiver_setup_form"
            ...
            <div class="">
                ...
                <select id="group" onchange="onGroupChange()" name="group"
                    ...
                    <option {{ (isset($sessionGroup) ? ($sessionGroup===$group->group_name ? 'selected' : '') :
                        $group->group_name === 'N/A') ? 'selected' : '' }}
        ...
        <form id="waiver_setup_Get" class="grid grid-cols-3 gap-5"
            ...
            <div class="">
                <label for="percentage" class="block mb-2 text-sm font-medium text-gray-900 ">Percentage
                    %:</label>
                <input type="number" value="{{ isset($sessionPercentage) ? $sessionPercentage : '' }}" name="percentage"
                    id="percentage"
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 border">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-300 last:border-gray-200 text-center">
                                    ...
                                    <td class="px-6 py-4">
                                        <input type="number" value="{{ $sessionPercentageAmounts[$fee->id] }}"
