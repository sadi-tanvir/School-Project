...
@section('Dashboard')
    ...
    >
        ...
        <img
            class="absolute right-0 h-72 -rotate-45"
            src="{{ asset('assets/images/dashboard-welcome-bg.svg') }}"
            alt=""
        />
    </div>
        ...
        <div class="col-span-3">
            <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                    ...
                    <div class="mb-4 mt-2 h-2.5 w-full rounded-full bg-gray-200">
                        <div
                            class="h-2.5 rounded-full bg-yellow-400"
                            style="width: {{ $sectionData->count() }}%"
                        ></div>
                    </div>
                    <div class="flex items-center justify-between text-white">
                        <p>Total Section</p>
                ...
                >
                    ...
                    <div class="mb-4 mt-2 h-2.5 w-full rounded-full bg-gray-200">
                        <div class="h-2.5 rounded-full bg-yellow-400" style="width: {{ $msgData->count() }}%"></div>
                    </div>
                    <div class="flex items-center justify-between text-white">
                        <p>Total Message</p>
                        <p class="font-semibold">{{ $msgData->count() }}</p>
                    </div>
                    ...
                    >
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                transform="translate(-1425.19 -288)"
                            ></path>
                        </g>
                    </svg>
                </span>
        ...
        <div class="">
            ...
            <div class="text-md mt-5 grid gap-3 font-semibold md:grid-cols-2">
                ...
                >
                    ...
                    <img
                        class="absolute -right-48 -top-14 h-40 -rotate-45"
                        src="{{ asset('assets/images/dashboard-welcome-bg.svg') }}"
                        alt=""
                    />
                </div>
