...
<div class="relative mb-3 overflow-hidden rounded-md bg-gradient-to-tr from-[#1E3A8A] to-[#0054af] px-10 py-16 text-white">
    <h2 class="text-4xl">
...
<div class="row-span-3 grid grid-cols-4 gap-3">
    <div class="col-span-3">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-red-600 to-orange-600 p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-7 right-8 rotate-180 opacity-20">
                    <svg width="95px" height="95px" viewBox="0 0 512 512" id="Layer_1" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-tr from-[#1E3A8A] to-[#0054af] p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-7 right-8 opacity-20">
                    <svg width="86px" height="86px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M2 14C2 10.2288 2 8.34315 3.17157 7.17157C4.34315 6 6.22876 6 10 6H14C17.7712 6 19.6569 6 20.8284 7.17157C22 8.34315 22 10.2288 22 14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2 19.6569 2 17.7712 2 14Z" stroke="#000000" stroke-width="1.5"></path>
                            <path d="M16 6C16 4.11438 16 3.17157 15.4142 2.58579C14.8284 2 13.8856 2 12 2C10.1144 2 9.17157 2 8.58579 2.58579C8 3.17157 8 4.11438 8 6" stroke="#000000" stroke-width="1.5"></path>
                            <path d="M12 17.3333C13.1046 17.3333 14 16.5871 14 15.6667C14 14.7462 13.1046 14 12 14C10.8954 14 10 13.2538 10 12.3333C10 11.4129 10.8954 10.6667 12 10.6667M12 17.3333C10.8954 17.3333 10 16.5871 10 15.6667M12 17.3333V18M12 10V10.6667M12 10.6667C13.1046 10.6667 14 11.4129 14 12.3333" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path>
                        </g>
                    </svg>
                </span>
            </div>
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-purple-600 to-purple-900 p-9 backdrop-blur-xl lg:mx-0">
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-blue-600 to-violet-600 p-9 backdrop-blur-xl lg:mx-0">
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-fuchsia-600 to-purple-600 p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-5 right-7 opacity-20">
                    <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 491.584 491.584" xml:space="preserve" width="95px" height="95px">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <g>
                                <g>
                                    <g>
                                        ...
                                        <rect x="252.702" y="55.616" transform="matrix(-0.4472 0.8944 -0.8944 -0.4472 519.6956 -193.9584)" width="134.164" height="15.999"></rect>
                                    </g>
                                </g>
                            </g>
                        </g>
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-blue-800 to-indigo-900 p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-4 right-7 opacity-20">
                    <svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="85px" height="85px" viewBox="0 0 29.936 29.936" xml:space="preserve">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <g>
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-emerald-600 to-emerald-900 p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-4 right-7 opacity-20">
                    <svg width="96px" height="96px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M5 3H3v2h2V3zm2 4h2v2H7V7zm4 0h2v2h-2V7zm2 12h-2v2h2v-2zm2 0h2v2h-2v-2zm6 0h-2v2h2v-2zM7 11h2v2H7v-2zm14 0h-2v2h2v-2zm-2 4h2v2h-2v-2zM7 19h2v2H7v-2zM19 7h2v2h-2V7zM7 3h2v2H7V3zm2 12H7v2h2v-2zM3 7h2v2H3V7zm14 0h-2v2h2V7zM3 11h2v2H3v-2zm2 4H3v2h2v-2zm6-12h2v2h-2V3zm6 0h-2v2h2V3z" fill="#000000"></path>
                        </g>
                    </svg>
                </span>
            </div>
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-stone-500 to-stone-700 p-9 backdrop-blur-xl lg:mx-0">
                ...
                <span class="absolute -top-4 right-7 opacity-20">
                    <svg width="95px" height="95px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-slate-500 to-slate-800 p-9 backdrop-blur-xl lg:mx-0">
            ...
            <div class="relative mx-2 overflow-hidden rounded-md bg-gradient-to-br from-slate-500 to-green-800 p-9 backdrop-blur-xl lg:mx-0">
    ...
    <div class="col-span-1 grid grid-rows-1">
        <div class="relative mx-2 grow overflow-hidden rounded-e-lg rounded-t-lg bg-gradient-to-br from-teal-200 to-teal-500 p-9 text-black lg:mx-0">
            ...
            <span class="absolute -bottom-2 right-6">
                <svg fill="#000000" width="80px" height="80px" viewBox="0 -2.85 29.69 29.69" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <defs>
        ...
        <div class="relative mt-4 grow overflow-hidden rounded-e-lg rounded-t-lg bg-gradient-to-br from-amber-500 to-pink-500 p-9 backdrop-blur-xl">
...
<div class="mt-4 grid gap-3 md:grid-cols-2">
    <div class="">
        <div class="rounded-e-lg rounded-t-xl border-2 border-[#1E3A8A] bg-gray-200 pb-8">
            ...
            <div class="mt-5 px-6">
                <div>
                    ...
                    <select name="year" id="date-dropdown" class="block w-full rounded-lg border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500">
                        <option>Select Year</option>
                    </select>
                </div>
                <div class="mt-5">
                    <label for="email" class="mb-1.5 block text-sm font-medium text-gray-900">Choose Exam</label>
                    <select id="countries" name="category" class="block w-full rounded-lg border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500">
                ...
                <div class="mt-5 text-end">
                    <button type="submit" class="rounded-lg bg-blue-700 px-16 py-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">
                        Search
                    </button>
                </div>
            </div>
        ...
        <div class="text-md mt-5 grid gap-3 font-semibold md:grid-cols-2">
            <div class="relative overflow-hidden rounded-md bg-gradient-to-br from-blue-600 to-blue-950 px-8 py-10 text-start text-white">
                <a href="#" class="">
                    <div class="text-xl font-light">
                        <p>Total Class: 0</p>
                    </div>
                </a>
                <img class="absolute -right-48 -top-14 h-40 -rotate-45" src="{{ asset('assets/images/dashboard-welcome-bg.svg') }}" alt="" />
            </div>
            <div class="relative overflow-hidden rounded-md bg-gradient-to-br from-blue-600 to-blue-950 px-8 py-10 text-start text-white">
                <a href="#" class="">
                    <div class="text-xl font-light">
    ...
    <div class="">
        ...
        <div class="text-md mt-3 space-y-1.5">
            <div class="relative overflow-hidden rounded-md bg-gradient-to-br from-purple-600 to-purple-900 px-8 py-10 text-start text-white">
                <a href="#" class="">
                    <div class="text-xl font-light">
                        <p>Total Pass: 0</p>
                    </div>
