...
<style>
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="text-center">Exam Progress Report</h2>
        <h3 class="text-xl text-white text-center"> এক্সাম প্রসেস করার পূর্বে অবশ্যই মার্ক ইনপুট করে নিবেন । তাছাড়া মার্ক প্রসেস কাজ করবে না । </h3>
...
<div class=" mb-3 card">
    <div class="  rounded-md ">
        <div class="border-2 p-6 rounded-md">
<form action="{{route('exam_process',$school_code)}}" method="POST">
@csrf
            <div class="row form-group">

                <div class="flex justify-between items-center mb-5">
                    <label for="class" class="text-gray-700 text-sm w-[150px] mr-2">Class:</label>
                    <select id="class" name="class" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400   dark:focus:ring-blue-500 dark:focus:border-blue-500 ">
                ...
                <div class="flex justify-between items-center mb-5">
                    ...
                    <select id="student" name="student_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
                ...
                <div class="flex justify-between items-center mb-5">
                    ...
                    <select name="exam_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
                        <option disabled selected value="">Select</option>
                ...
                <div class="flex justify-between items-center mb-5">
                    ...
                    <select name="merit_status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
                        <option disabled selected value="">Select</option>
                ...
                <div class="row form-group">
                    <div class="offset-md-8 col-md-2">
                        <button type="submit" style="width: 100%;" class=" btn-hover__new btn-hover focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  " id="feesCollectSaved">Print</button>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#class').change(function() {
                ...
                $.ajax({
                    url: "{{ route('exam_process.get-groups', $school_code) }}",
                    method: 'post',
                    data: {
                        class: class_name,
                        _token: '{{ csrf_token() }}'
            ...
            $('#class').change(function() {
                var class_name = $(this).val();
                $.ajax({
                    url: "{{ route('exam_process.get-sections', $school_code) }}",
                    method: 'post',
                    data: {
                        class: class_name,
                        _token: '{{ csrf_token() }}'
            ...
            $('#class').change(function() {
                var class_name = $(this).val();
                $.ajax({
                    url: "{{ route('exam_process.get-student', $school_code) }}",
                    method: 'post',
                    data: {
                        class: class_name,
                        _token: '{{ csrf_token() }}'
