    ...
    <div class="w-full border mx-auto p-5 space-y-10">
        ...
        <div class="w-2/5 mx-auto">
            <form action="{{ url('') }}" method="POST">
                ...
                <div class="py-5 px-2 space-y-3 flex flex-col">
                    ...
                    <div class="grid grid-cols-4 space-x-5 items-center">
                        <label for="bill_challan_no" class="ml-auto mb-2 text-sm font-medium text-gray-900 ">Bill/Challan
                            No.</label>
                    ...
                    <div class="grid grid-cols-4 space-x-5 items-center">
                        <label for="bill_challan_no" class="ml-auto mb-2 text-sm font-medium text-gray-900 ">Bank Account</label>
                    ...
                    <div class="grid grid-cols-4 space-x-5 items-center">
                        <label for="available_cash_balance"
                            class="ml-auto mb-2 text-sm font-medium text-gray-900 ">Available Cash Balance</label>
                        <input type="text" value="0" name="available_cash_balance" id="available_cash_balance"
                            class="col-span-3 bg-gray-50 border border-gray-300 px-5 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-1 block w-5/6"
                            placeholder="" />
                    </div>
                </div>
        ...
        <div class="space-y-1">
            <div class="bg-blue-200 text-center rounded-lg">
                <h1 class="py-1">Bank Payment Voucher</h1>
            </div>
            <button type="button"
