                ...
                <div class="py-5 px-2 space-y-3 flex flex-col">
                    ...
                    <div class="grid grid-cols-4 space-x-5 items-center">
                        ...
                        <select id="group" name="group"
                            class="col-span-3 bg-gray-50 border px-5 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-5/6 p-1  dark:border-gray-600    dark:focus:ring-blue-500 dark:focus:border-blue-500">
