        ...
        <div class="w-3/5 mx-auto">
            <form action="{{ url('') }}" method="POST">
                ...
                <div class="flex flex-col justify-center space-y-3 border p-5">
                    ...
                    <div class="p-6 px-2 space-x-3 grid grid-cols-12">
                        <div class="col-span-3">
                            <h1 class="text-xl font-semibold">BANK ACCOUNT</h1>
                        </div>
                        <select id="group" name="group"
                            class="col-span-9 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1">
