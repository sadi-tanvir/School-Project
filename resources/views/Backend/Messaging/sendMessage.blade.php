                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 p-5">
                        ...
                        <div class="">
                            ...
                            <select id="section" name="section_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="">
                            ...
                            <select id="group" name="group_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="">
                            ...
                            <select id="shift" name="shift_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="">
                            ...
                            <select id="Category" name="category_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div class="">
                            ...
                            <select id="Session" name="session_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option disabled selected value="">Select Session</option>
                                @foreach ($sessions as $data)
                                <option value="{{ $data->academic_session_name }}">{{ $data->academic_session_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="">
                            ...
                            <select id="Year" name="year_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class=" mb-3 mt-5">
            <form action="{{ route('sendMessage') }}" method="POST" class="p-5 ">
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{ $data->id }}" class="border-b">
                                <td scope="col" class="text-sm px-6 py-3">
                                    <input type="checkbox" name="contact[{{ $data->mobile_no }}]" value="{{ $data->mobile_no }}" class="row-checkbox" data-row-id="{{ $data->id }}">
                                </td>
                                <td scope="col" class="text-sm px-6 py-3">
                                    {{ $key+1 }}
                                </td>
                ...
                <div class="w-full flex justify-end">
                    ...
                    <a href="{{route('dashboard.index',$school_code)}}" class="  text-white bg-red-700 hover:bg-red-600 focus:ring-0  font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Close
</a>
                </div>
            </form>
        </div>
