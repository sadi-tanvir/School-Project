...
<div class="flex justify-center items-center">
    <form class="md:max-w-[800px] mx-auto border-2 p-5" action="{{route('admin.add')}}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <button type="submit my-5"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto w-full  px-5 py-2.5 text-center  ">Submit</button>
    </form>
</div>
