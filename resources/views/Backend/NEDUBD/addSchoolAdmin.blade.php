...
<style>
    ...
    <form class="rounded-md border-2 p-5 bg-gray-100 " action="{{route('schoolAdmin.create')}}", method="POST", enctype="multipart/form-data">
@csrf
<div class="grid grid-cols-8 ">
    <div class="col-span-2">
    <div class="pt-1.5 col-span-2">
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
        <div class="relative z-0 w-full group">
                <select onchange="setSchoolCode()" id="schoolName"
                    class="bg-transparent  border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  border-b-only   ">
        ...
        <select id="role" name="role" class="bg-transparent border-b-only border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
        ...
        <button type="submit"
             class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto  px-16 py-3.5 text-center  ">Submit</button>
         </div>
    </div>
   </div>
</div>
