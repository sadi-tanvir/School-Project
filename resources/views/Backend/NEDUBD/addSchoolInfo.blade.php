...
@section('Dashboard')
    ...
    <form
        class="w-full rounded-md border-2 bg-gray-100 p-5"
        action="{{ route('schoolInfo.add') }}"
        method="POST"
        ,
    ...
    >
        ...
        <div class="grid md:grid-cols-8">
            <div class="col-span-2">
                <label class="mb-2 block text-sm font-medium text-gray-900" for="logo">Upload Picture</label>
                <input name="logo" class="hidden" id="logo" type="file" onchange="previewImage(this)" />
                <div
                    id="imagePreview"
                    class="upload-box mt-2 rounded-md border-2 border-dashed"
            ...
            <div class="col-span-6">
                <div class="group relative z-0 mb-5 w-full">
                    ...
                    <label
                        ...
                        class="peer-focus: absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-blue-600 rtl:peer-focus:translate-x-1/4"
                    >
                        School Name
                    </label>
                </div>
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="group relative z-0 mb-5 w-full">
                        ...
                        <label
                            for="floating_email"
                            class="peer-focus: absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:start-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-blue-600 rtl:peer-focus:left-auto rtl:peer-focus:translate-x-1/4"
                        >
                ...
                <button
                    type="submit"
                    class="mt-2 w-full rounded-md bg-blue-700 px-7 py-3.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto"
                >
                    Submit
                </button>
            </div>
