...
<td class="px-6 py-4 border border-black">{{$exam->gpa}}</td>
        ...
        <div class="grid grid-cols-3 mt-10 text-center">
            ...
            <div class="grid grid-cols-2 md:ml-10">
                ...
                <div class=" text-justify border-l border-r border-black p-1 col-span-2 ">
                    ...
                    Congratulations on your brilliant result. If you desire to be a
                    real successful man, obtain ‘A ’ in your character, then obtain
                    ‘A ’ in your study. May Allah bestow you the capability. Keep
    ...
    <div class="flex justify-center mt-10">
        ...
        <div>
            ...
            <button id="" type="button" class="text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Download</button>
            </a> --}}
