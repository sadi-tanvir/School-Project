...
<body class="bg-blue-100">
    <div class="bg-blue-50 w-[1500px] px-[120px] mx-auto border-[10px] border-blue-500" id="page">
        <!-- Watermark -->
        <div class="watermark">
            <img src="https://i.pinimg.com/originals/82/c6/5b/82c65b9bb0a75026fc4c82a438b4cc9b.jpg" alt="Watermark Logo" class="w-full">
        </div>
        ...
        <div class="content">
            <div class="grid grid-cols-3 w-full justify-between items-center p-5">
                ...
                <div class="text-center">
                    ...
                    <div class="flex justify-center">
                        <img id="logo" src="https://i.pinimg.com/originals/82/c6/5b/82c65b9bb0a75026fc4c82a438b4cc9b.jpg" class="rounded-full w-28 h-28" alt="">
                    </div>
            ...
            <div class="grid grid-cols-8 mt-1 text-center font-bold">
                ...
                <div class="border-l border-b border-t border-black p-1.5">Name Of Subjects</div>
                <div class="border-l border-b border-t border-black p-1.5">Full Marks</div>
                <div class="border-l border-b border-t border-r border-black p-1.5">Highest Marks</div>
                <div class="border-b border-t border-black p-1.5">WR</div>
                <div class="border-l border-b border-t border-black p-1.5">Total Marks</div>
                <div class="border-l border-b border-t border-black p-1.5">Letter Grade</div>
                <div class="border-l border-b border-t border-r border-black p-1.5">Grade WR Point</div>
