...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-6 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Exam Mark Setup Grand Final</h2>
    ...
    <form action="{{ route('store.grandfinal', $school_code) }} " method="POST">
        ...
        <div class="mx-10 md:flex">
            <div class="mb-5 mr-5 flex justify-center border md:mb-0 md:mr-32">
                <div class="mx-10 my-10">
                    ...
                    @foreach ($classData as $data)
                        <div>
                            ...
                            />
                            <label for="subject_name" class="ms-2 w-full py-4 text-sm font-medium text-gray-900">
                                {{ $data->class_name }}
                            </label>
                        </div>
                    @endforeach
            ...
            <div>
                <div class="text-md flex justify-center font-bold">
                    <h2>EXAM WISE GRAND FINAL SETTING</h2>
                </div>
                <table class="w-full text-left text-sm text-black rtl:text-right">
                    <thead class="border-b border-blue-400 bg-blue-600 text-xs uppercase text-white">
                        <tr>
                            ...
                            <th scope="col" class="bg-blue-500 px-6 py-3">EXAM NAME</th>
                            <th scope="col" class="px-6 py-3">PERCENTAGE</th>
                            <th scope="col" class="bg-blue-500 px-6 py-3">EXAM SERIAL</th>
        ...
        <div class="z-56 sticky mt-10 grid md:grid-cols-3">
            <div class="mr-10 justify-center md:flex">
                <a href="{{ url('dashboard/viewExamMarkSetup', $school_code) }}">
                    <button
                        type="button"
