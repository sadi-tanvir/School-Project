    ...
    <form action="" class="p-5 shadowStyle rounded-[8px] border border-slate-300 w-2/5 mx-auto space-y-3">
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="class" class="block mb-2 text-sm font-medium whitespace-noWrap ">Class
                :</label>
            <select id="class" name="class" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="group" class="block mb-2 text-sm font-medium whitespace-noWrap ">Group
                :</label>
            <select id="group" name="group" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="section" class="block mb-2 text-sm font-medium whitespace-noWrap ">Section
                :</label>
            <select id="section" name="section" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="roll" class="block mb-2 text-sm font-medium whitespace-noWrap ">Student Roll
                :</label>
            <input id="roll" placeholder="Enter Student Roll" class="bg-gray-50 placeholder:text-black text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2" type="text">
        </div>
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="exam_name" class="block mb-2 text-sm font-medium whitespace-noWrap ">Exam Name
                :</label>
            <select id="exam_name" name="exam_name" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="merit_status" class="block mb-2 text-sm font-medium whitespace-noWrap ">Merit Status
                :</label>
            <select id="merit_status" name="merit_status" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="grid grid-cols-3 place-items-start  gap-5">
            <label for="year" class="block mb-2 text-sm font-medium whitespace-noWrap ">Year
                :</label>
            <select id="year" name="year" class="bg-gray-50  text-gray-900 text-sm rounded-lg  block w-full p-2.5 col-span-2">
        ...
        <div class="w-full flex justify-end">
            <a href="/dashboard/downloadProgressReport/{{ $school_code }}"></a><button type="text" class="w-1/3  text-white bg-blue-700 hover:bg-blue-600 focus:ring-0  font-medium rounded-lg text-sm px-3 py-2.5 me-2 mb-2 focus:outline-none">Print
            </button>
        </div>
    </form>
</div>
