...
@include('Shared.ContentHeader', ['title' => 'Add Staff Department'])
...
<div class="w-full rounded-md mx-auto p-6 bg-gray-200 border-2 border-gray-300 space-y-3">
    <div class="w-full flex justify-between items-center gap-4">
        <div class="flex space-x-6">
            <button data-modal-target="add_staff_department_modal" data-modal-toggle="add_staff_department_modal" type="button"
            ...
            {{-- Add department modal form start --}}
            <div id="add_staff_department_modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative bg-white rounded-lg shadow p-4">
                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ">
                            <h3 class="text-xl font-semibold text-gray-900 ">
                                New Staff department entry form
                            </h3>
                            <button type="button"
                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center "
                                data-modal-hide="add_staff_department_modal">
                        ...
                        <form method="POST" action="{{route("staffDepartment.create", $school_code)}}"
                            class="w-full mx-auto">
                            @csrf
                            <div class="p-4 md:p-5 space-y-4">

                                <div class="mb-5">
                                    <label for="department" class="block mb-2 text-sm font-medium text-gray-900 ">Staff department:</label>
                            ...
                            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b ">
                                ...
                                <button data-modal-hide="add_staff_department_modal" type="button"
        ...
        <div class="mt-10">
            <div class="relative overflow-x-auto sm:rounded-lg">
                <table class="w-full border text-sm text-left rtl:text-right text-gray-500 ">
                    ...
                    <tbody class="">
                        @foreach ($staffDepartments as $key => $department)
                        <tr class="border-b">
                            ...
                            <td class="px-6 py-4 flex justify-center items-center space-x-5">
                                ...
                                <form method="POST"
                                    action="{{route("staffDepartment.delete", ["schoolCode" => $school_code, "id" => $department->id])}}">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <div class="mb-3">
                                    <svg data-modal-target="update_staff_department_modal_{{ $department->id }}"
                                        data-modal-toggle="update_staff_department_modal_{{ $department->id }}"
                                    ...
                                    {{-- Update Staff department modal form start --}}
                                    <div id="update_staff_department_modal_{{ $department->id }}" tabindex="-1" aria-hidden="true"
                                        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative p-10 w-full max-w-2xl max-h-full">
                                            <div class="relative bg-white rounded-lg shadow ">
                                                <div
                                                    ...
                                                    <h3 class="text-xl font-semibold text-gray-900 ">
                                                        Update Staff department of <span class="text-blue-500 font-semibold">{{
                                                            $department->department }}</span>
                                                    </h3>
                                                    <button type="button"
                                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center "
                                                        data-modal-hide="update_staff_department_modal_{{ $department->id }}">
                                                ...
                                                <form method="POST"
                                                    action="{{route("staffDepartment.update", ["schoolCode" => $school_code, "id" => $department->id])}}"
                                                    class="">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    {{-- Update Staff department modal form end --}}
                                </div>
                            </td>
                        </tr>
                        @endforeach
