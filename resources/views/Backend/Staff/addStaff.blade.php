    ...
    <form action="{{route('stuff.create', $school_code)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div class="">
                ...
                <input type="text" readOnly value="{{$staffId}}" name="staff_id" id=""
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border border-4">
            ...
            <div>
                ...
                <select id="blood" type="text" name="blood"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
                    <option selected disabled>Choose blood</option>
                    <option>A+</option>
                    <option>A-</option>
                    <option>B+</option>
                    <option>B-</option>
        ...
        <div class="grid gap-4 mb-6 md:grid-cols-7 p-5 border border-4">
            ...
            <div>
                <label for="college_department" class="block mb-2 text-sm font-medium text-gray-900 ">Department
