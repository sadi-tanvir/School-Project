...
<div class="mx-10 mt-10">
    <form method="POST" action="{{route("staff.update", ["id" => $staff->id, "schoolCode" => $school_code])}}" class="">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div class="">
                <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 ">Teacher'sId</label>
                <input type="text" readOnly value="{{$staff->staff_id}}" name="staff_id" id=""
            ...
            <div>
                <label for="emg_mobile" class="block mb-2 text-sm font-medium text-gray-900 ">Emergency
                    Mobile</label>
                <input type="text" name="emg_mobile" id="emg_mobile" value="{{$staff->emg_mobile}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                <label for="fbid" class="block mb-2 text-sm font-medium text-gray-900 ">FB ID</label>
                <input type="text" id="fbid" name="fbid" value="{{$staff->fbid}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <select id="department" type="text" name="department"
                    ...
                    @foreach ($staffDepartments as $department)
                        <option class="capitalize" value="{{$department->department}}"
                            {{$department->department === $staff->department ? "selected" : ""}}>{{$department->department}}
                        </option>
                    @endforeach
                </select>
            </div>
            <div>
                ...
                <select id="designation" type="text" name="designation"
                    ...
                    @foreach ($staffDesignations as $designation)
                        <option class="capitalize" value="{{$designation->designation}}"
                            {{$designation->designation === $staff->designation ? "selected" : ""}}>
            ...
            <div>
                ...
                <input type="text" name="subject" id="subject" value="{{$staff->subject}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="subject" />
            </div>
            ...
            <div>
                ...
                <input type="text" name="index" id="index" value="{{$staff->index}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="salary_account" id="salary_account" value="{{$staff->salary_account}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="pf" id="pf" value="{{$staff->pf}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    name</label>
                <input type="text" name="father_name" id="first_name" value="{{$staff->father_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="father_mobile" id="father_mobile" value="{{$staff->father_mobile}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Mobile No" />
            </div>
            ...
            <div>
                ...
                <input type="text" name="mother_number" id="mother_number" value="{{$staff->mother_number}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div>
                ...
                <div class="relative max-w-sm">
                    ...
                    <input datepicker datepicker-autohide type="text" name="birth_date" value="{{$staff->birth_date}}"
            ...
            <div>
                ...
                <input type="text" name="nationality" id="nationality" value="{{$staff->nationality}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <select id="blood" type="text" name="blood"
                    ...
                    <option {{$staff->blood === "A+" ? "selected" : ""}}>A+</option>
                    <option {{$staff->blood === "A-" ? "selected" : ""}}>A-</option>
                    <option {{$staff->blood === "B+" ? "selected" : ""}}>B+</option>
                    <option {{$staff->blood === "B-" ? "selected" : ""}}>B-</option>
                    <option {{$staff->blood === "AB+" ? "selected" : ""}}>AB+</option>
                    <option {{$staff->blood === "AB-" ? "selected" : ""}}>AB-</option>
                    <option {{$staff->blood === "O+" ? "selected" : ""}}>O+</option>
                    <option {{$staff->blood === "O-" ? "selected" : ""}}>O-</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" name="nid" id="nid" value="{{$staff->nid}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <select id="marital_status" type="text" name="marital_status"
                    ...
                    <option {{$staff->marital_status === "Unmarried" ? "selected" : ""}}>Single</option>
                    <option {{$staff->marital_status === "Married" ? "selected" : ""}}>Married</option>
                    <option {{$staff->marital_status === "Divorced" ? "selected" : ""}}>Divorced</option>
                </select>
            </div>
            <div>
                <label for="age" class="block mb-2 text-sm font-medium text-gray-900 ">Age
                </label>
                <input type="text" name="age" id="age" value="{{$staff->age}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <select id="religious" type="text" name="religious"
                    ...
                    <option {{$staff->religious === "Islam" ? "selected" : ""}}>Islam</option>
                    <option {{$staff->religious === "Hinduism" ? "selected" : ""}}>Hinduism</option>
                    <option {{$staff->religious === "Buddhism" ? "selected" : ""}}>Buddhism</option>
                    <option {{$staff->religious === "Christian" ? "selected" : ""}}>Christian</option>
                </select>
            </div>
            <div>
                <label for="company" class="block mb-2 text-sm font-medium text-gray-900 ">Joining Date</label>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div>
                <label for="present_village" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Village</label>
                <input type="text" name="present_village" id="present_village" value="{{$staff->present_village}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Village Name" />
            </div>
            <div>
                <label for="present_post_office" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Post Office
                </label>
                <input type="text" name="present_post_office" id="present_post_office"
                    value="{{$staff->present_post_office}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Post Office" />
            </div>

            <div>
                <label for="present_zip_code" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Zip Code/Post_code
                </label>
                <input type="text" name="present_zip_code" id="present_zip_code" value="{{$staff->present_zip_code}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Present Zip Code/Post_code" />
            </div>
            <div>
                <label for="present_district" class="block mb-2 text-sm font-medium text-gray-900 ">present
                    District</label>
                <input type="text" name="present_district" id="present_district" value="{{$staff->present_district}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The District Name" />
            </div>
            <div>
                <label for="present_police_station" class="block mb-2 text-sm font-medium text-gray-900 ">present
                    Police Station
                </label>
                <input type="text" name="present_police_station" id="present_police_station"
                    value="{{$staff->present_police_station}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4">
            <div>
                <label for="parmanent_village" class="block mb-2 text-sm font-medium text-gray-900 ">Parmanent
                    Village</label>
                <input type="text" name="parmanent_village" id="parmanent_village" value="{{$staff->parmanent_village}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Village Name" />
            </div>
            <div>
                <label for="parmanent_post_office" class="block mb-2 text-sm font-medium text-gray-900 ">Parmanent
                    Post Office
                </label>
                <input type="text" name="parmanent_post_office" id="parmanent_post_office"
                    value="{{$staff->parmanent_post_office}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Post Office" />
            </div>

            <div>
                <label for="parmanent_zip_code" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    Zip Code/Post_code
                </label>
                <input type="text" name="parmanent_zip_code" id="parmanent_zip_code"
                    value="{{$staff->parmanent_zip_code}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Parmanent Zip Code/Post_code" />
            </div>
            <div>
                <label for="parmanent_district" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    District</label>
                <input type="text" name="parmanent_district" id="parmanent_district"
                    value="{{$staff->parmanent_district}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The District Name" />
            </div>
            <div>
                <label for="parmanent_police_station" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    Police Station
                </label>
                <input type="text" name="parmanent_police_station" id="parmanent_police_station"
                    value="{{$staff->parmanent_police_station}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Police Station Name" />
            </div>
        ...
        <div class="grid gap-4 mb-6 md:grid-cols-7 p-5 border-4">
            ...
            <div>
                ...
                <input type="text" name="school_name" id="school_name" value="{{$staff->school_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The School Name" />
            </div>
            <div>
                <label for="ssc_department" class="block mb-2 text-sm font-medium text-gray-900 ">Department

                </label>
                <input type="text" name="ssc_department" id="ssc_department" value="{{$staff->ssc_department}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="ssc_roll" id="ssc_roll" value="{{$staff->ssc_roll}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="ssc_reg" id="ssc_reg" value="{{$staff->ssc_reg}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="ssc_gpa" id="ssc_gpa" value="{{$staff->ssc_gpa}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" name="ssc_year" id="ssc_year" value="{{$staff->ssc_year}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <select type="text" id="hsc" name="hsc"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     ">
            ...
            <div>
                ...
                <input type="text" name="college_name" id="college_name" value="{{$staff->college_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The School Name" />
            </div>
            <div>
                <label for="college_department" class="block mb-2 text-sm font-medium text-gray-900 ">Department</label>
                <input type="text" name="college_department" id="college_department"
                    value="{{$staff->college_department}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Department Name" />
            </div>
            <div>
                ...
                <input type="text" name="college_roll" id="college_roll" value="{{$staff->college_roll}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Roll No" />
            </div>
            <div>
                <label for="college_reg" class="block mb-2 text-sm font-medium text-gray-900 ">Registration No

                </label>
                <input type="text" name="college_reg" id="college_reg" value="{{$staff->college_reg}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Registration No" />
            </div>
            <div>
                ...
                <input type="text" name="college_gpa" id="college_gpa" value="{{$staff->college_gpa}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The GPA" />
            </div>
            <div>
                <label for="college_passing_year" class="block mb-2 text-sm font-medium text-gray-900 ">Passing Year

                </label>
                <input type="text" name="college_passing_year" id="college_passing_year"
                    value="{{$staff->college_passing_year}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Passing Year" />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" name="versity_name" id="versity_name" value="{{$staff->versity_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The School Name" />
            </div>
            <div>
                <label for="versity_department" class="block mb-2 text-sm font-medium text-gray-900 ">Department

                </label>
                <input type="text" name="versity_department" id="versity_department"
                    value="{{$staff->versity_department}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Department Name" />
            </div>
            <div>
                ...
                <input type="text" name="versity_roll" id="versity_roll" value="{{$staff->versity_roll}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Roll No" />
            </div>
            <div>
                <label for="versity_reg" class="block mb-2 text-sm font-medium text-gray-900 ">Registration No

                </label>
                <input type="text" name="versity_reg" id="versity_reg" value="{{$staff->versity_reg}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Registration No" />
            </div>
            <div>
                ...
                <input type="text" name="versity_gpa" id="versity_gpa" value="{{$staff->versity_gpa}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The GPA" />
            </div>
            <div>
                <label for="versity_passing_year" class="block mb-2 text-sm font-medium text-gray-900 ">Passing Year

                </label>
                <input type="text" name="versity_passing_year" id="versity_passing_year"
                    value="{{$staff->versity_passing_year}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Passing Year" />
            </div>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-3 p-5 border-4">
            <div>
                <label for="qua_name" class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
                <input type="text" id="qua_name" name="qua_name" value="{{$staff->qua_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter Name" />
            </div>
            <div>
                <label for="qua_industry_name" class="block mb-2 text-sm font-medium text-gray-900 ">Industry Name
                </label>
                <input type="text" name="qua_industry_name" id="qua_industry_name" value="{{$staff->qua_industry_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter Industry Name" />
            </div>
            <div>
                <label for="qua_description" class="block mb-2 text-sm font-medium text-gray-900 ">Description
                </label>
                <input type="text" name="qua_description" id="qua_description" value="{{$staff->qua_description}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
            ...
            <div>
                ...
                <input type="text" id="qua_name" name="qua_2_name" value="{{$staff->qua_2_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter Name" />
            </div>
            <div>
                <label for="qua_2_industry_name" class="block mb-2 text-sm font-medium text-gray-900 ">Industry Name
                </label>
                <input type="text" name="qua_2_industry_name" id="qua_2_industry_name"
                    value="{{$staff->qua_2_industry_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter Industry Name" />
            </div>
            <div>
                <label for="qua_2_description" class="block mb-2 text-sm font-medium text-gray-900 ">Description
                </label>
                <input type="text" name="qua_2_description" id="qua_2_description" value="{{$staff->qua_2_description}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter your Description" />
            </div>
        </div>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 border-4 ">
            <div>
                ...
                <input type="text" name="post_name" id="post_name" value="{{$staff->post_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5     "
                    placeholder="Enter The Post Name" />
            </div>
            <div>
                <label for="industrial_name" class="block mb-2 text-sm font-medium text-gray-900 ">Industry Name
                </label>
                <input type="text" name="industrial_name" id="industrial_name" value="{{$staff->industrial_name}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div>
                ...
                <input type="text" name="start_date" id="start_date" value="{{$staff->start_date}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div>
                ...
                <input type="text" name="end_date" id="end_date" value="{{$staff->end_date}}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Enter The Police End Date" />
            </div>
            <!-- <div class="hidden">
                <label for="role" class="block mb-2 text-sm font-medium text-gray-900 "></label>
                <input type="text" value="teacher" name="role" id="role"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
            </div> -->
            <div class="hidden">
                <label for="action" class="block mb-2 text-sm font-medium text-gray-900 "></label>
