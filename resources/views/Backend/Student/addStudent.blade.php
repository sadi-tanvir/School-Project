...
<div class="">
    <form action="{{ url('/dashboard/create-student') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-6 rounded-md bg-gray-200 border-2">
            <div>


                <label for="nedubd_student_id" class="block mb-2 text-sm font-medium text-gray-900 ">NEDUBD Student ID</label>
                <input type="text" readOnly value="{{$studentId}}" name="nedubd_student_id" id="nedubd_student_id" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="" />
            </div>
            <div>

                <label for="student_id" class="block mb-2 text-sm font-medium text-gray-900 ">Institute Student ID</label>
                <input type="text" name="student_id" id="student_id" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="student_id" />
            </div>
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Name</label>
                <input type="text" name="name" id="name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The  Name" />
            </div>
            <div>
            ...
            <div>
                <label for="website" class="block mb-2 text-sm font-medium text-gray-900 ">student
                    Roll</label>
                <input type="text" name="student_roll" id="website" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="student_roll" />
            </div>
            <div>
            ...
            <div>
                ...
                <select id="section" name="section" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div>
                ...
                <select id="shift" name="shift" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="category" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select name="year" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="gender" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="religious" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="nationality" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="blood_group" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select id="countries" name="session" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  ">
            ...
            <div class="mb-6">
                ...
                <select name="status" id="status" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-3.5 ">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-6 rounded-md bg-gray-200 border-2">
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    name</label>
                <input type="text" name="father_name" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The  Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    Mobile
                </label>
                <input type="text" name="father_mobile" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Mobile No" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    Occupation
                </label>
                <input type="text" name="father_occupation" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Occupation" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    Yearly Income
                </label>
                <input type="text" name="father_income" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Income" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    NID
                </label>
                <input type="text" name="father_nid" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The NID" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Father's
                    Birthdate
            ...
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                    Name</label>
                <input type="text" name="mother_name" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The  Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                    Number
                </label>
                <input type="text" name="mother_number" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Number" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                    occupation
                </label>
                <input type="text" name="mother_occupation" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The occupation" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                    NID
                </label>
                <input type="text" name="mother_nid" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The NID" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                    Birthdate
                ...
                <div class="relative max-w-sm">
                    ...
                    <input datepicker datepicker-autohide type="text" name="mother_birth_date" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-3.5   " placeholder="Select date">
                </div>
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Mother's
                ...
                <input type="text" name="mother_income" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Mother's Income" />
            </div>
        </div>
        <div class="font-medium mb-1">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-6 rounded-md bg-gray-200 border-2">
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Village</label>
                <input type="text" name="present_village" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Village Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Post Office
                </label>
                <input type="text" name="present_post_office" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Post Office" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Country
                </label>
                <input type="text" name="present_country" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Country Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Present
                    Zip Code/Post_code
                </label>
                <input type="text" name="present_zip_code" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Present Zip Code/Post_code" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">present
                    District</label>
                <input type="text" name="present_district" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The District Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">present
                    Police Station
                </label>
                <input type="text" name="present_police_station" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Police Station Name" />
            </div>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-6 rounded-md bg-gray-200 border-2">
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Parmanent
                    Village</label>
                <input type="text" name="parmanent_village" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Village Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Parmanent
                    Post Office
                </label>
                <input type="text" name="parmanent_post_office" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Post Office" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">Parmanent
                    Country
                </label>
                <input type="text" name="parmanent_country" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5  " placeholder="Enter The Country Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    Zip Code/Post_code
                </label>
                <input type="text" name="parmanent_zip_code" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Present Zip Code/Post_code" />
            </div>
            <div>
                <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    District</label>
                <input type="text" name="parmanent_district" id="first_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The District Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">parmanent
                    Police Station
                </label>
                <input type="text" name="parmanent_police_station" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2 p-6 rounded-md bg-gray-200 border-2">
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Guardian
                    Name

                </label>
                <input type="text" name="guardian_name" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Guardian
                    Address
                </label>
                <input type="text" name="guardian_address" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
        </div>
        <div class="font-medium mb-1">
            <h3>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4 p-6 rounded-md bg-gray-200 border-2">
            <div>
                ...
                <input type="text" name="last_school_name" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Last School Name" />
            </div>
            <div>
                ...
                <input type="text" name="last_class_name" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Last Class Name" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Last
                    Result
                ...
                <input type="text" name="last_result" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Last Result" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Last
                    Passing year
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2 p-6 rounded-md bg-gray-200 border-2">
            <div>
                ...
                <input type="email" id="email" name="email" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter your email" />
            </div>
            <div>
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Password
                </label>
                <input type="password" name="password" id="floating_password" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter your password" />
            </div>
        </div>

        <div class="grid gap-6 mb-6 md:grid-cols-4 p-5 hidde6 rounded-md bg-gray-200 border-2">
            <div class="hidden">
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Role
                </label>
                <input type="text" value="student" name="role" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
            <div class="hidden">
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Action
                </label>
                <input type="text" value="approved" name="action" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
            <div class="hidden">
                <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">School Code
                </label>
                <input type="text" value="{{ $school_code }}" name="school_code" id="last_name" class="bg-white border-0 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5    " placeholder="Enter The Police Station Name" />
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#class').change(function() {
            var class_name = $(this).val();
            $.ajax({
                url: "{{ route('add.get-shifts', $school_code) }}",
                method: 'post',
                data: {
                    class: class_name,
                    _token: '{{ csrf_token() }}'
