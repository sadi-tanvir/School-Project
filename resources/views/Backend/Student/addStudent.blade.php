        ...
        <form action="{{ url('/dashboard/create-student') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-4 p-5  border-4">
                <div>
                    ...
                    <label for="nedubd_student_id" class="block mb-2 text-sm font-medium text-gray-900 ">NEDUBD Student
                        ID</label>
                    <input type="text" readOnly value="{{ $studentId }}" name="nedubd_student_id"
            ...
            <div class="flex justify-center items-center gap-20">
                <div class="flex items-center gap-2">
                    <input checked id="add_related_fees" name="add_related_fees" type="checkbox" value=""
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $('#shift').append(
                        '<option disabled selected value="">Select</option>');
                    $.each(result, function(key, value) {
                        $('#shift').append('<option value="' + value.shift_name +
