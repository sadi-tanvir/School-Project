...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto border-x-2 border-b-2 pt-6 sm:rounded-lg">
        ...
        <form class="border-t-2 bg-gray-200 p-6" action="{{ route('postStudent') }}" method="POST">
            @csrf

            <div class="mt-10 items-center justify-end md:flex">
                <div class="md:mr-4">
                    <select
                        id="year"
                        name="year"
            ...
            <div class="mb-2 text-xs text-rose-700">
                If you have a student ID, enter it. Otherwise, it'll generate a new one automatically.
            </div>
            <table id="student-table" class="w-full text-left text-sm text-black rtl:text-right">
                <thead class="border-b border-blue-400 bg-blue-600 text-xs uppercase text-white">
                    <tr>
                        ...
                        <th scope="col" class="bg-blue-500 px-6 py-3">Father Name</th>
                        <th scope="col" class="px-6 py-3">Mother Name</th>
                        <th scope="col" class="bg-blue-500 px-6 py-3">Mobile</th>
                        <th scope="col" class="px-6 py-3">Birthdate</th>
                        <th scope="col" class="bg-blue-500 px-6 py-3">Gender</th>
                        <th scope="col" class="px-6 py-3">Religion</th>
                        <th scope="col" class="bg-blue-500 px-6 py-3">BG</th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
            <div class="mb-6 mt-10 items-center justify-end md:flex">
                <div class="md:mr-4">
                    <select
                        id="class"
                        name="class_name"
