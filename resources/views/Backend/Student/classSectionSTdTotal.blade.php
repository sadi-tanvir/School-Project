...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Class Section Total Student</h2>
    ...
    <div class="">
        <div class="border-2 border-gray-300 bg-gray-200 p-6">
            <form
                action="{{ route('classSectionStdTotalDownload', $school_code) }}"
                method="POST"
                ...
                <div class="mb-5">
                    ...
                    <div class="col-span-2">
                        <select
                            id="countries"
                            name="class"
                            class="block w-full rounded-lg border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-0"
                        >
