...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto rounded-md border-2">
        <form action="">
            <div class="grid gap-6 border-b-2 bg-gray-100 p-6 md:grid-cols-5">
                <div>
                    <select
                        id=""
                        name="class"
                        class="block w-full rounded-md border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                    >
                ...
                <div>
                    <select
                        id=""
                        name="group"
                        class="border- block w-full rounded-md border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                    >
            ...
            >
                <tr>
                    <input
                        ...
                        type="checkbox"
                        value=""
                        class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-blue-600 focus:ring-2 focus:ring-blue-500 dark:ring-offset-gray-800 dark:focus:ring-blue-600"
                    />
                    ...
                    <th scope="col" class="bg-blue-500 px-6 py-3">Migrate Class</th>
                    <th scope="col" class="px-6 py-3">Total Mark</th>
                    <th scope="col" class="bg-blue-500 px-6 py-3">M.Roll</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
        <div class="z-56 sticky mb-5 grid md:mt-32 md:grid-cols-2">
            <div class="flex items-center gap-3">
                ...
                <div class="">
                    <a href="">
                        <button
                            type="button"
                            class="w-full rounded-md bg-rose-400 px-20 py-3.5 text-center text-sm font-medium text-white hover:bg-rose-400 focus:outline-none focus:ring-4 focus:ring-rose-300 sm:w-auto dark:bg-rose-300 dark:hover:bg-rose-400 dark:focus:ring-rose-400"
                        >
                            Close
                        </button>
                    </a>
