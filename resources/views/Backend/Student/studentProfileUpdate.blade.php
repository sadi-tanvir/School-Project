...
@section('Dashboard')
    ...
    <div class="gradient-bg py-4 px-6 text-white font-semibold mb-4 rounded-md relative overflow-hidden">
        <h2 class=""> Student Profile Update</h2>
    ...
    <div class="relative overflow-x-auto border-2 sm:rounded-lg p-6">
        ...
        <form action="{{ route('find.Data', $school_code) }}" method="post">
            ...
            <div class="grid gap-2  md:grid-cols-9 mb-8">
                <div>
                    <a href="{{ route('AddStudentForm', $school_code) }}">
                        <button type="button"
                            class=" text-white bg-rose-700 hover:bg-rose-600 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-rose-600 dark:hover:bg-rose-700 focus:outline-none dark:focus:ring-rose-800 h-full flex items-center justify-center gap-3">
                            <span>Add</span>
                            <span>
                ...
                <div>
                    ...
                    <select id="class" name="class_name"
                        class="bg-gray-50 border h-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:border-gray-600    dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div>
                    <select id="group" name="group"
                        class="bg-gray-50 border  h-full border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                ...
                <div>
                    ...
                    <a 
                        ...
                        <span><svg fill="#ffffff" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xml:space="preserve" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M42,43H18c-0.553,0-1,0.447-1,1s0.447,1,1,1h24c0.553,0,1-0.447,1-1S42.553,43,42,43z"></path> <path d="M42,48H18c-0.553,0-1,0.447-1,1s0.447,1,1,1h24c0.553,0,1-0.447,1-1S42.553,48,42,48z"></path> <g> <path d="M51,17V0H9v17H0v34h6v3h3v6h42v-6h3v-3h6V17H51z M11,2h38v15H11V2z M49,54v4H11v-4V37h38V54z M50,32c-2.757,0-5-2.243-5-5 s2.243-5,5-5s5,2.243,5,5S52.757,32,50,32z"></path> <circle cx="50" cy="27" r="3"></circle> </g> </g> </g></svg></span>
                </a>
                </div>
            </div>
        </form>
