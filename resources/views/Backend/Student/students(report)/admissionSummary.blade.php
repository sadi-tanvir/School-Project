...
<div class="">
    <div class="rounded-md border-2 border-gray-200 bg-gray-200 p-6">
            ...
            <div class="mb-5">
                ...
                <div class="col-span-2">
                    <select id="class" name="class"
                        class="block w-full rounded-md border-0 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-0">
                ...
                <div class="col-span-2">
                    <select id="year" name="year"
                        ...
                        @foreach ($year as $yearData)
                            <option>{{ $yearData->academic_year_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
