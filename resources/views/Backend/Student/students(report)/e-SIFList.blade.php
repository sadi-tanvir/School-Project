...
@section('Dashboard')
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">E SIF Lists | Student Information</h2>
    ...
    <div class="relative overflow-x-auto border-2 bg-gray-100 sm:rounded-lg md:p-5">
        <div class="mb-6 mt-2 space-y-4">
            ...
            <div>
                <label class="mb-2 block text-sm font-medium text-gray-900" for="user_avatar">Session</label>
                <select
                    id=""
                    name="session"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
        ...
        <div class="justify-end md:flex">
            <div class="">
                <button
                    type="button"
                    class="mb-2 flex w-full items-center justify-center gap-3 rounded-lg bg-rose-600 px-10 py-3.5 text-sm font-medium text-white hover:bg-rose-600 focus:outline-none focus:ring-4 focus:ring-rose-600"
                >
                    <span>Print</span>
                    <span>
                        <svg
