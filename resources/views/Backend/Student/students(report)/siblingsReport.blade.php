                ...
                <div class="bg-white rounded-lg shadow-md p-5">
                    <ul class="flex border-b">
                        <li class="-mb-px mr-1">
                            <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold"
                                href="#father" onclick="openTab(event, 'father')">Father</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block  py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold"
                                href="#mother" onclick="openTab(event, 'mother')">Mother</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#id"
                                onclick="openTab(event, 'studentId')">Student ID</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#info"
                                onclick="openTab(event, 'matchInfo')">Match Info</a>
                        </li>
                    </ul>
                    <div id="father" class="tab-content mt-6">
                        <form action="{{ route('fatherMatch', $school_code) }}" class="space-y-6" method="Get">
                            ...
                            <div>
                                <label for="father_mobile" class="block text-sm font-medium text-gray-700">Father's
                                    Mobile</label>
                            ...
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Search</button>
                        </form>
                    </div>
                    <div id="mother" class="tab-content mt-6 hidden">
                        <form action="{{ route('motherMatch', $school_code) }}" class="space-y-6" method="Get">
                            ...
                            <div>
                                <label for="mother_mobile" class="block text-sm font-medium text-gray-700">Mother's
                                    Mobile</label>
                    ...
                    <div id="matchInfo" class="tab-content mt-6 hidden">
                        <form action="{{ route('studentMatch', $school_code) }}" class="space-y-6" method="GET">
                            ...
                            <div id="fixed-fields" class="grid grid-cols-2 gap-5">
                                <div>
                                    <label for="stu1_id" class="block text-sm font-medium text-gray-700">Student
                                        ID</label>
                                    <input type="text" id="stu1_id" name="stu_ids[]"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                        required>
                                </div>
                                <div>
                                    <label for="stu2_id" class="block text-sm font-medium text-gray-700">Student
                                        ID</label>
                                    <input type="text" id="stu2_id" name="stu_ids[]"
                                        class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                        required>
                                </div>
                            ...
                            <button type="button" id="add-field"
                                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Add
                                Student ID <i class="fa-solid fa-user-plus pl-5"></i></button>
            ...
            function openTab(evt, tabName) {
                ...
                for (i = 0; i < tablinks.length; i++) {
                    tablinks[i].className = tablinks[i].className.replace(
                        "border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold",
