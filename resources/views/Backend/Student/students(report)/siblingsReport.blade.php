...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class=""> Siblings Information</h2>
    ...
    <body class="bg-gray-100 ">
        <div class="flex justify-center">
            <div class="container mx-32 mt-5">
                <div class="bg-white rounded-lg shadow-md p-5">
                    <ul class="flex border-b">
                        <li class="-mb-px mr-1">
                            <a class="bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold" href="#father" onclick="openTab(event, 'father')">Father</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block  py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#mother" onclick="openTab(event, 'mother')">Mother</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#id" onclick="openTab(event, 'studentId')">Student ID</a>
                        </li>
                        <li class="mr-1">
                            <a class="inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold" href="#info" onclick="openTab(event, 'matchInfo')">Match Info</a>
                        </li>
                    </ul>
                    <div id="father" class="tab-content mt-6">
                        <form method="" action="" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="father_mobile" name="father_mobile" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
                    ...
                    <div id="mother" class="tab-content mt-6 hidden">
                        <form method="" action="" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="mother_name" name="mother_name" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
                            <div>
                                <label for="mother_mobile" class="block text-sm font-medium text-gray-700">Mother's Mobile</label>
                                <input type="text" id="mother_mobile" name="mother_mobile" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
                            <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Search</button>
                        </form>
                    </div>
                    <div id="studentId" class="tab-content mt-6 hidden">
                        <form method="" action="" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="id" name="studentId" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                            </div>
        ...
        <script>
            function openTab(evt, tabName) {
                ...
                for (i = 0; i < tablinks.length; i++) {
                    tablinks[i].className = tablinks[i].className.replace("border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold", "inline-block py-2 px-4 text-blue-500 hover:text-blue-800 font-semibold");
                }
                document.getElementById(tabName).style.display = "block";
                evt.currentTarget.className = "bg-white inline-block border-l border-t border-r rounded-t py-2 px-4 text-blue-700 font-semibold";
            }
            document.getElementById('father').style.display = "block"; // Show default tab content
            </script>
@endsection
