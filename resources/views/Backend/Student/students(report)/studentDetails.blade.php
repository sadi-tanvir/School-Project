...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Student Details Information</h2>
    ...
    <div class="">
        <div class="rounded-md border-2 bg-gray-100 p-6">
            <form
                action="{{ route('StudentDetailsPrint', $school_code) }}"
                method="POST"
            ...
            >
                ...
                <div class="mb-5">
                    <div class="">
                        <label for="last_name" class="mb-2 block text-sm font-medium capitalize">Student Id:</label>
                        <select
                            name="id"
                            id="student-select"
                            class="block w-full rounded-lg border-0 border-gray-300 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-0"
                ...
                <div class="flex justify-end">
                    <button
                        type="submit"
                        class="F flex w-full items-center justify-center gap-3 rounded-lg bg-rose-600 px-10 py-3.5 text-center text-sm font-medium text-white hover:bg-rose-800 focus:outline-none focus:ring-0 sm:w-auto"
                    >
                        <span>Print</span>
                        <span>
                            <svg
