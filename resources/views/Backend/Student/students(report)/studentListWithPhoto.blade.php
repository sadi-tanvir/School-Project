...
@section('Dashboard')
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Student Information with Image</h2>
    ...
    <form action="{{ route('viewStudentListPhoto') }}" method="POST">
        ...
        <div class="relative overflow-x-auto border-2 bg-gray-100 sm:rounded-lg md:p-6">
            <div class="mb-6 mt-2 grid gap-6 md:grid-cols-4">
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-900" for="user_avatar">Class</label>
                    <select
                        id=""
                        name="class"
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-900" for="user_avatar">Group</label>
                    <select
                        id=""
                        name="group"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-gray-900" for="user_avatar">Section</label>
                    <select
                        id=""
                        name="section"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
            ...
            <div class="grid grid-cols-2 md:grid-cols-4">
                @foreach ($columns as $column)
                    <div class="">
                        ...
                        />
                        <label for="{{ $column }}" class="ms-2 w-full py-4 text-sm font-medium text-gray-900">
                            {{ $column }}
                        </label>
                    </div>
                @endforeach
            ...
            <div class="mt-10 justify-end md:flex">
                <div class="">
                    <button
                        type="submit"
                        class="mb-2 flex h-full w-full items-center justify-center gap-3 rounded-md bg-blue-700 px-6 py-3.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        <span>Search</span>
                        <span>
                            <svg
