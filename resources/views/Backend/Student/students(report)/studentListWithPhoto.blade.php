...
<form action="{{ route('viewStudentListPhoto') }}" method="POST">
    ...
    <div class="relative overflow-x-auto border-2 bg-gray-100 sm:rounded-lg md:p-6">
        ...
        <div class="mt-10 justify-end md:flex">
            <div class="">
                <button type="submit"
                    class="mb-2 flex h-full w-full items-center justify-center gap-3 rounded-md bg-blue-700 px-6 py-3.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300      ">
                    <span>Search</span>
                    <span>
