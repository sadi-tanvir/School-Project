                                ...
                                <table class="min-w-full text-left text-sm font-light">
                                    <thead class="border-b font-medium">
                                        <tr>
                                            ...
                                            <th scope="col" class="min-w-16 max-w-32 p-3">Amount</th>
                                            <th scope="col" class="min-w-16 max-w-32 p-3">Waiver</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-b table_row">
                                            <td class="min-w-16 max-w-32 p-3"> {{ $key + 1 }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->month }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->pay_slip_type }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->amount }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->waiver }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->amount - $payslip->waiver }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->paid_amount ?? 0 }} </td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $payslip->due_amount ?? $payslip->payable }} </td>
                                            <td class="min-w-16 max-w-32 p-3 font-semibold uppercase {{$payslip->payment_status === 'unpaid' ? 'text-red-500' : 'text-green-500'}}"> {{ $payslip->payment_status }} </td>
                                        </tr>
                                        @endforeach

                                        <tr class="border-b table_row">
                                            <td colspan="3" class="min-w-16 max-w-32 p-3 font-medium text-right">Total</td>
                                            <td class="min-w-16 max-w-32 p-3">{{ $totalAmount }}</td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $totalWaiver }} </td>
                                            <td class="min-w-16 max-w-32 p-3">{{ $totalDue }}</td>
                                            <td class="min-w-16 max-w-32 p-3"> {{ $totalReceived }} </td>
                                            <td class="min-w-16 max-w-32 p-3">{{ $totalDue }}</td>
                                            <td class="min-w-16 max-w-32 p-3"></td>
                                        </tr>
                                        <!-- More rows here -->
