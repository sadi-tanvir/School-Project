...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold">
        <h2 class="text-white">Student Profile Information</h2>
    ...
    <div class="rounded-md border-2 bg-gray-100">
        <div class="p-6">
            <form
                action="{{ route('student_ProfileReport', $school_code) }}"
                method="GET"
                enctype="multipart/form-data"
            >
                @csrf
                <div class="mb-5">
                    <label for="class" class="mb-2 block text-sm font-medium">Class:</label>
                ...
                <div class="mb-5">
                    <label class="mb-2 block text-sm font-medium">Student ID:</label>
                ...
                <div class="mb-5">
                    <label for="year" class="mb-2 block text-sm font-medium">Academic Year:</label>
