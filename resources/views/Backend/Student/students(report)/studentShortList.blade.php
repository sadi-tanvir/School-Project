...
<div class="gradient-bg py-4 px-6 text-white font-semibold mb-4 rounded-md relative overflow-hidden">
        <h2 class=""> Student Short List Information</h2>
...
@csrf
    <div class="relative overflow-x-auto sm:rounded-lg border-2 bg-gray-100 md:p-5">
            ...
            <div>
                ...
                <div class="relative max-w-sm">
                    ...
                    <input datepicker datepicker-autohide type="text" name="from_date"
                        class="bg-white border-0 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-3.5      "
