...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Transfer Certificate List</h2>
    ...
    <div class="">
        <div class="rounded-md border-2 border-gray-300 bg-gray-200 p-6">
            <form action="" method="" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">From Date</label>
                    </div>
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="text"
                            name="from_date"
                            class="block w-full rounded-md border-0 bg-white p-2.5 ps-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">To</label>
                    </div>
                    <div class="relative">
                        <div class="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-3">
                            <svg
                ...
                <div class="mb-5">
                    ...
                    <div class="">
                        <select
                            id="countries"
                            name="id"
                            class="block w-full rounded-md border-0 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-0"
                        >
