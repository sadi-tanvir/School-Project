...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Transfer Certificate</h2>
    ...
    <div class="">
        <div class="rounded-md border-2 border-gray-300 bg-gray-200 p-6">
            <form action="" method="" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Appear Exam:</label>
                    </div>
                    <div class="">
                        <select
                            id="countries"
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Appear Year:</label>
                    </div>
                    <div class="">
                        <input
                            id=""
                            placeholder="Enter Appear Year"
                            name="Class_name"
                            class="block w-full rounded-lg border-0 border-gray-300 bg-white p-3.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-0"
                        />
                    </div>
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Promoted Class:</label>
                    </div>
                    <div class="">
                        <input
                            id=""
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Detained Class:</label>
                    </div>
                    <div class="">
                        <input
                            id=""
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Reason For Leave:</label>
                    </div>
                    <div class="">
                        <select
                            id="countries"
                ...
                <div class="mb-5">
                    <div class=" ">
                        <label for="last_name" class="mb-2 block text-sm font-medium">Last Payment MOnth:</label>
                    </div>
                    <div class="">
                        <input
                            id=""
