...
@section('Dashboard')
    ...
    <div class="relative overflow-x-auto border-x-2 border-b-2 pt-6 sm:rounded-lg">
        ...
        <form
            class="border-t-2 bg-gray-200 p-6"
            action="{{ route('getStudentClassData', $school_code) }}"
            method="GET"
        >
            @csrf

            <div class="mb-6 mt-2 grid grid-cols-1 gap-3 md:grid-cols-10">
                <div>
                    <label for="class" class="text-xs text-gray-700">Class:</label>
                    <select
                        id="class"
                        name="class_name"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                    >
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Group:</label>
                    <select
                        id="group"
                        name="group"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Section:</label>
                    <select
                        id="section"
                        name="section"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Category:</label>
                    <select
                        id=""
                        name="category"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Shift:</label>
                    <select
                        id="shift"
                        name="shift"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="gender" class="text-xs text-gray-700">Gender:</label>
                    <select
                        id="gender"
                        name="gender"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Year:</label>
                    <select
                        id="year"
                        name="year"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Session:</label>
                    <select
                        id=""
                        name="session"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label for="class" class="text-xs text-gray-700">Status:</label>
                    <select
                        id=""
                        name="status"
                        class="block w-full rounded-lg border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div class="flex items-end justify-end">
                    <div class="">
                        <button
                            type="submit"
                            class="me-2 rounded-lg bg-blue-700 px-7 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300"
                        >
                            Search
                        </button>
                    </div>
        ...
        <form action="{{ route('updateStudentClass', $school_code) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-3 bg-gray-200 p-6 md:grid-cols-12">
            <div>
    <button
        id="delete-btn"
        type="button"  
        class="mb-2 me-2 rounded-lg bg-rose-700 px-3 py-1 text-sm font-medium text-white hover:bg-rose-600 focus:outline-none focus:ring-4 focus:ring-rose-300"
        disabled  
    >
        Delete
    </button>
                ...
                <button
                    type="submit"
                    class="mb-2 me-2 rounded-lg bg-blue-700 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300"
                >
                    Update
                </button>
            </div>

            <div class="mt-5 flex justify-start p-2">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateDeleteButtonStatus() {
        var anyChecked = Array.from(rowCheckboxes).some(checkbox => checkbox.checked);
    ...
    document.getElementById('delete-btn').addEventListener('click', function () {
        ...
        if (confirmation) {
            ...
            var form = document.createElement('form');
            form.method = 'POST'; // Use POST method to submit the form
            form.action = '{{ route('deleteStudent', ['schoolCode' => $school_code]) }}';
            form.style.display = 'none'; // Hide the form
