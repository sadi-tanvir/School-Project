...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg mx-10 md:my-10">
    <div class="md:flex justify-end  ">
        <a href="{{ route('updateStudentBasicInfo', $school_code) }}">
            <button type="button" class=" text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none ">Basic
                Info
            </button>
        </a>
        <a href="{{ route('studentClassInfo', $school_code) }}">
            <button type="button" class=" text-white bg-rose-700 hover:bg-rose-600 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none ">Class
                Info
            </button>
        </a>

        <a href="{{route('StudentPhoto',$school_code)}}">
            <button type="button" class=" text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Photo

            </button>
        </a>

        <a href="{{ route('getStudent', $school_code) }}">
            <button type="button" class="  text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add
                Student
            </button>
        </a>
    </div>
    ...
    <form action="{{ route('getStudentClassData', $school_code) }}" method="GET">
        ...
        <div class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-10 mt-2">
            <div>
            ...
            <div>
                ...
                <select id="" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                ...
                <select id="" name="session" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div class="flex justify-end">
                <button type="submit" class="  text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2  focus:outline-none ">Search
                </button>
            </div>
        </div>
    </form>
    <form action="{{ route('updateStudentClass', $school_code) }}" method="POST">
            ...
            <thead class="text-xs text-white uppercase bg-blue-600 border-b border-blue-400 ">
                <tr>
                    <th scope="col" class="px-6 py-3 bg-blue-500">
                        <input id="select-all-checkbox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                    </th>
                    <th scope="col" class="px-6 py-3 bg-blue-500">
                        Name
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select name="Class_name[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
                            <option value="{{ $data->Class_name }}">{{ $data->Class_name }}</option>
                    ...
                    <td class="px-6 py-4 ">
                        ...
                        <select name="group[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select name="section[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
                    ...
                    <td class="px-6 py-4 ">
                        ...
                        <select name="session[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select name="year[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <select name="status[{{ $data->id }}]" class="form-control row-input hidden md:w-[120px] md:h-[30px] px-2">
        ...
        <div class="grid gap-6 mb-6 grid-cols-1 md:grid-cols-12 mt-5">
            <div><a id="delete-btn" class="text-white bg-rose-700 hover:bg-rose-600 focus:ring-4 focus:ring-rose-300 font-medium rounded-lg text-sm px-3 py-1 me-2 mb-2  focus:outline-none ">Delete</a></div>
            <div></div>


            <div>
                <select id="n_class" name="Class_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                <select id="n_group" name="group" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                <select id="n_section" name="section" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                <select id="n_shift" name="shift" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                <select id="n_gender" name="gender" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            ...
            <div>
                <select id="n_year" name="year" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                    @foreach ($Year as $year)
                    <option value="{{ $year->academic_year_name }}">{{ $year->academic_year_name }}</option>
                    @endforeach
                </select>
            ...
            <button type="submit" class="  text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm me-2 mb-2  focus:outline-none">Update
            </button>
        </div>
...
<script>
    $(document).ready(function() {
        $('#n_class').change(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    $('#n_group').empty();
                    $('#n_group').append('<option disabled selected value="">Group</option>');
                    $.each(result, function(key, value) {
                        $('#n_group').append('<option value="' + value.group_name + '">' + value.group_name + '</option>');
                    });
                }
            });
        });
        ...
        $('#n_class').change(function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    $('#n_section').empty();
                    $('#n_section').append('<option disabled selected value="">Section</option>');
                    $.each(result, function(key, value) {
                        $('#n_section').append('<option value="' + value.section_name + '">' + value.section_name + '</option>');
                    });
                }
            });
        });
    ...
    $('#n_class').change(function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                $('#n_shift').empty();
                $('#n_shift').append('<option disabled selected value="">Shift</option>');
                $.each(result, function(key, value) {
                    $('#n_shift').append('<option value="' + value.shift_name + '">' + value.shift_name + '</option>');
                });
            }
        });
    });
