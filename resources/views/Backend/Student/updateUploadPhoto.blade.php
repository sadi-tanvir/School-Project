...
@section('Dashboard')
    ...
    <div class="gradient-bg relative mb-4 overflow-hidden rounded-md px-6 py-4 font-semibold text-white">
        <h2 class="">Student Photo Upload</h2>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-md">
        <div class="inline-block rounded-t-xl border-x border-t px-2 pt-2">
        ...
        <form class="border bg-slate-200" action="{{ route('updatePhoto', $school_code) }}" method="POST">
            @csrf

            <div class="mb-6 mt-2 grid gap-3 p-3 md:grid-cols-7">
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Class</label>
                    <select
                        id="class"
                        name="class"
                ...
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Group</label>
                    <select
                        id="group"
                        name="group"
                        class="block w-full rounded-md border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                    >
                ...
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Section</label>
                    <select
                        id="section"
                        name="section"
                        class="block w-full rounded-md border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Category</label>
                    <select
                        id=""
                        name="category"
                        class="block w-full rounded-md border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Gender</label>
                    <select
                        id="gender"
                        name="gender"
                        class="block w-full rounded-md border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
                ...
                <div>
                    <label class="mb-2 block text-xs font-medium text-gray-900" for="user_avatar">Academic Year</label>
                    <select
                        id=""
                        name="academic_year"
                        class="block w-full rounded-md border-0 border-gray-300 bg-white p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
        ...
        <table class="w-full text-left text-sm text-black rtl:text-right  ">
            <thead class="border-b border-blue-400 bg-blue-600 text-xs uppercase text-white  ">
                <tr>
                    ...
                    <th scope="col" class="bg-blue-500 px-6 py-3">Photo</th>
                    <th scope="col" class="px-6 py-3">Upload Photo</th>
                </tr>
            </thead>
            <tbody>
                @if ($students != null)
                    @if (! is_null($students) && count($students) > 0)
                        @foreach ($students as $student)
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    <img class="w-16" src="{{ asset($student->image) }}" alt="student Image" />
                                </td>
                                <td class="px-6 py-4">
                                    <form
                                        id="uploadForm{{ $student->id }}"
                                        method="POST"
                                        action="{{ route('update.student.image', ['schoolCode' => $school_code, 'id' => $student->id]) }}"
