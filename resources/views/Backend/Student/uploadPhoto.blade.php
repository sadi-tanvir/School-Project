...
<div class="mx-10 border mt-10">
    ...
    <div class="grid md:grid-cols-2 mx-32 md:mt-10">
        ...
        <div class="mt-6 md:ml-20">
            <button type="submit"
                class="px-10  text-white bg-blue-700 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm py-2.5 me-2 mb-2     focus:outline-none  ">
                Submit
            </button>
