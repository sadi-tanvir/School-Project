                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                                ...
                                <tr class="odd:bg-white even:bg-gray-50 border-b text-center">
                                    <td scope="row" class="px-3 py-4 font-medium text-gray-900 whitespace-nowrap"></td>
                                    <td scope="row" class="px-3 py-4 font-medium text-gray-900 whitespace-nowrap"></td>
                                    <td scope="row" class="px-3 py-4 font-medium text-gray-900 whitespace-nowrap"></td>
                                    <td class="px-6 py-4 text-end font-bold  text-lg"></td>
                                    <td class="px-6 py-4 font-bold text-lg text-center">{{ $totalAmount }}</td>
                                    <td class="px-6 py-4 text-center font-bold text-lg">{{$totalReceived}}</td>
                                    <td class="px-6 py-4 text-center font-bold text-lg">{{$totalWaiver}}</td>
                                    <td class="px-6 py-4 text-center font-bold text-lg">{{$totalDue}}</td>
                                    <td class=" py-4 font-bold text-lg"></td>
                                    <td class=" py-4 font-bold text-lg"></td>
                                </tr>
                            </tbody>
                        </table>
