                ...
                <div class="w-full flex justify-between items-center mb-5">
                    <div class="space-y-2">
                        <h1 class="font-semibold text-gray-500">Class:
                            <span class="bg-gray-100 font-bold rounded-lg px-1.5 py-1">Play</span>
                        </h1>
                    </div>
                    <div>
                        <h1 class="font-semibold text-gray-500">Group:
                            <span class="bg-gray-100 font-bold rounded-lg px-1.5 py-1">N/A</span>
                        </h1>
                    </div>
                </div>
                <div class="mt-10">
                        ...
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                            ...
                            <tbody>
                                ...
                                <tr class="odd:bg-white even:bg-gray-50 border-b text-center">
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('printPaidInvoice.voucherId', ['schoolCode' => $school_code, 'voucher_id' => str_replace('#', '', $payslip->voucher_number)]) }}"
