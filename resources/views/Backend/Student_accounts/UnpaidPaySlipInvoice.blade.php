...
@section('Dashboard')
    ...
    <div class="w-full min-h-screen bg-neutral-200 mx-auto p-5">
        <a id="deletePayslip" href="{{ route('printUnpaidPaySlip.view', $school_code) }}"
                                ...
                                <div class="">
                                    ...
                                    <div class="border border-gray-300 grid grid-cols-6">
                                        <div class="w-full text-wrap col-span-3 border-r p-1">
                                            <p><span class="font-semibold">Note:</span> Last Payment Date: <span
                                                    class="font-bold">{{ $last_payment_date }}</span>
                                            </p>
                                        </div>
