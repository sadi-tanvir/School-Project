...
<div class="w-full min-h-screen bg-neutral-200 mx-auto p-5">
    <a id="deletePayslip" href="{{ route('printUnpaidPaySlip.view', $school_code) }}" class="text-white bg-gradient-to-br from-red-600 to-red-500 hover:bg-gradient-to-bl focus:ring-red-300 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center mx-auto">Back</a>
                    ...
                    <div class="grid grid-cols-2 text-[10px]">
                        ...
                        <div class="flex">
                            ...
                            <ul>
                                ...
                                <li>: </li>
                                <li>:
                                    {{ isset($schoolAdminData->mobile_number) ? $schoolAdminData->mobile_number : 'Unknown' }}
                                </li>
                            </ul>
                        </div>
                        <div class="">
                            <ul>
                                <li>Academic Year <span class="ml-2">:</span>
                                    {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->year :""}}</li>
                                <li>Student ID : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->student_id  : ""}}</li>
                                <li>Name : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->name : ""}}</li>
                                <li>Class : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->Class_name : ""}}</li>
                                <li>Group : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->group : ""}}</li>
                                <li>Section : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->section : ""}}</li>
                                <li>Roll No. : {{ isset($individualPayslip['student_info']) ? $individualPayslip['student_info']->student_roll : ""}}</li>
                            </ul>
                        </div>
                        {{-- <div class="">
                                    <img class="w-16"
                        ...
                        <div class="">
                            <table class="w-full divide-y divide-zinc-200 border border-b-0">
                                ...
                                <tbody class="bg-white divide-y divide-zinc-200">
                                    @foreach ($individualPayslip['slips'] as $key => $paySlip)
                                    <tr class="">
                            ...
                            <div class="border border-gray-300 grid grid-cols-6">
                                <div class="w-full text-wrap col-span-3 border-r p-1">
                                    <p><span class="font-semibold">Note:</span> Last Payment Date: <span class="font-bold">{{ $last_payment_date }}</span>
                                    </p>
                                </div>
                                <div class="col-span-3 grid grid-cols-2">
                                    ...
                                    <ul class="border-l grid columns-4">
                                        <li class="p-px border-b  font-bold">
                                            {{ $individualPayslip['total_payable'] }}
                                        </li>
                                        <li class="p-px border-b ">{{ $individualPayslip['total_waiver'] }}</li>
                                        <li class="p-px border-b ">{{ $individualPayslip['total_paid'] }}</li>
                                        <li class="p-px ">{{ $individualPayslip['total_payable'] }}</li>
                                    </ul>
                                </div>
                            </div>
