    ...
    <div class="mt-10">
        <div class="md:mx-52 border-2 p-10">
            ...
            <div class="grid md:grid-cols-3 mb-5">
                ...
                <div class="">
                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600    dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
                </div>
            </div>
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
