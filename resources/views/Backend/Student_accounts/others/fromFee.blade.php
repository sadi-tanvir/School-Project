...
@section('Dashboard')
    ...
    <div class="mt-10">
        <div class="md:mx-52 border-2 p-10">
            ...
            <div class="grid md:grid-cols-3 mb-5">
                <div class=" ">
                    <label for="last_name" class="block mb-2 text-lg font-medium text-gray-900 ">Admission ID :
                    </label>
                </div>
                <div class="">
                    <select id="countries" name="id"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <option selected>Choose Admission ID</option>
                        <option >x</option>
                        <option >y</option>
                        <option >z</option>
                    </select>
            ...
            <div class=" flex justify-end">
                <button type="submit"
                class="mr-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Refresh</button>
                <button type="submit"
