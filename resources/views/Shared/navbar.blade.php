<nav class="fixed top-0 z-50 w-full gradient-bg shadow-lg">
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="h-4">
        <form action="/dashboard/search/{{$school_code}}" method="GET">
          <input type="text" id="id" placeholder="Enter Student id" name="id" class="rounded border border-white placeholder-white text-white
                   active:outline-none active:ring-0 focus:ring-0 focus:border-white -mt-2 py-0.5 bg-transparent">
        </form>
      </div>
