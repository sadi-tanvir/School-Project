        ...
        <ul class="space-y-2 pb-6  font-medium ">
            ...
            <li>
                <a href="/dashboard/{{ $school_code }}" class="flex items-center py-2 px-4 text-white  group">
                    <svg class="w-5 h-5 text-white transition duration-75  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" viewBox="0 0 22 21">
            ...
            <li class="dropdown">
                <button type="button" class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition-all duration-700 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-nedubd" data-collapse-toggle="dropdown-nedubd">
                ...
                <ul id="dropdown-nedubd" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="/dashboard/addAdmin/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Create
                            New Member</a>
                    </li>
                    <li>
                        <a href="/dashboard/addSchoolInfo/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20 ">Add
                            School Info</a>
                    </li>
                    <li>
                        <a href="/dashboard/addSchoolAdmin/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition  rounded-lg pl-5 group ">Add
                            School Admin</a>
                    </li>
                </ul>
            </li>
            ...
            <!-- Student route  -->
            <li class="dropdown">
                <button class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group cursor-pointer hover:bg-slate-100/20" aria-controls="dropdown-student" data-collapse-toggle="dropdown-student">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" class="w-6 h-6">
                ...
                <ul id="dropdown-student" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="{{ route('AddStudentForm', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                            New Student </a>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        <p class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group cursor-pointer" aria-controls="dropdown-student_report" data-collapse-toggle="dropdown-student_report">
                            <svg class="w-5 h-5 text-white transition duration-75 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
                                <rect fill="none" />
                                <line x1="32" y1="64" x2="32" y2="144" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="8" />
                                <path d="M54.2,216a88.1,88.1,0,0,1,147.6,0" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="8" />
                                <polygon points="224 64 128 96 32 64 128 32 224 64" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="8" />
                                <path d="M169.3,82.2a56,56,0,1,1-82.6,0" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="8" />
                            </svg>
                        ...
                        <ul id="dropdown-student_report" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            <li>
                                <a href="/dashboard/studentDetails/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Student Details</a>
                            </li>
                            <li>
                                <a href="/dashboard/studentShortList/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
            ...
            <!-- student attendance -->
            <li class="dropdown">
                <button type="button" class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-Attendence" data-collapse-toggle="dropdown-Attendence">
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white ">Student Attendence</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                    </svg>

                </button>
                <ul id="dropdown-Attendence" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="/dashboard/addStudentAttendence/{{$school_code}}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add STD Attendance</a>
                    </li>

                    {{-- Reports (Student Attendance) --}}
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-report-attendence" data-collapse-toggle="dropdown-report-attendence">
                        ...
                        <ul id="dropdown-report-attendence" class="hidden py-2 space-y-2 pl-5">
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/accountsVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Attendance Report</a>
                            </li>
            ...
            {{-- Admit Card --}}
            <li class="dropdown">
                <button type="button" class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-admit-card" data-collapse-toggle="dropdown-admit-card">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" class="w-6 h-6">
                ...
                <ul id="dropdown-admit-card" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="/dashboard/setAdmitCard/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Set
                            Admit Card
                        </a>
                    </li>
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-report-card" data-collapse-toggle="dropdown-report-card">

                            <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white ">Reports(Admit
                                Cards)
                            </span>
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                        ...
                        <ul id="dropdown-report-card" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            <li>
                                <a href="/dashboard/printAdmitCard/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Print
                                    Admit Card
                                </a>
                            </li>
                            <li >
            ...
            {{-- exam and Result --}}
            <li class="dropdown">
                <button class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition-all duration-700 rounded-lg group cursor-pointer hover:bg-slate-100/20" aria-controls="dropdown-exam" data-collapse-toggle="dropdown-exam">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                ...
                <ul id="dropdown-exam" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="/dashboard/marksInput/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                            Marks Input </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/dashboard/exam_sms/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Exam SMS</a>
                    </li>

                    <!-- grand final  -->
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-grand" data-collapse-toggle="dropdown-grand">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                    ...
                    <li class="dropdown">
                        <button class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group cursor-pointer hover:bg-slate-100/20" aria-controls="dropdown-report" data-collapse-toggle="dropdown-report">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
            ...
            <li class="dropdown">
                <button class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group cursor-pointer hover:bg-slate-100/20" aria-controls="dropdown-message" data-collapse-toggle="dropdown-message">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                        <path d="M20 22H4C3.44772 22 3 21.5523 3 21V3C3 2.44772 3.44772 2 4 2H20C20.5523 2 21 2.44772 21 3V21C21 21.5523 20.5523 22 20 22ZM19 20V4H5V20H19ZM7 6H11V10H7V6ZM7 12H17V14H7V12ZM7 16H17V18H7V16ZM13 7H17V9H13V7Z">
                        </path>
                    </svg>
                ...
                <ul id="dropdown-message" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="/dashboard/contact/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                            Contact </a>
                    </li>
                    <li>
                        <a href="{{route('addMsg', $school_code)}}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                            Message </a>
                    </li>
                    <li>
                        <a href="/dashboard/message/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Send
                            Message</a>
                    </li>
                    <li>
                        <a href="/dashboard/excelmsg/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Excel</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul id="dropdown-student-Accounts" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    ...
                    <li>
                        <a href="/dashboard/studentAccounts/deletePaySlip/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Delete
                            Payslip</a>
                    </li>
                    <li>
            ...
            <li class="dropdown">
                ...
                <ul id="dropdown-student-Attendence" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    ...
                    <li>
                        <a href="/dashboard/generalAccounts/cashReceiptVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Cash
                            Receipt Voucher</a>
                    </li>
                    <li>
                        <a href="/dashboard/generalAccounts/bankPaymentVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Bank
                            Payment Voucher</a>
                    </li>
                    <li>
                        <a href="/dashboard/generalAccounts/bankReceiptVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Bank
                            Receipt Voucher</a>
                    </li>
                    <li>
                        <a href="/dashboard/generalAccounts/journalVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Journal
                            Voucher</a>
                    </li>
                    <li>
                        <a href="/dashboard/generalAccounts/contraVoucher/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Contra
                            Voucher</a>
                    </li>
                    <li>
                        <a href="/dashboard/generalAccounts/voucherPosting/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Voucher
                            Posting</a>
                    </li>
                    {{-- Reports (General Accounts) --}}
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-general-accounts-report" data-collapse-toggle="dropdown-general-accounts-report">
                        ...
                        <ul id="dropdown-general-accounts-report" class="hidden py-2 space-y-2 pl-5">
                            ...
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/cashBook/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Cash
                                    Book</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/bankBook/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Bank
                                    Book</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/journalBook/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Journal
                                    Book</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/incomeExpenseSummary/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Income
                                    Expense Summary</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/trialBalance/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Trial
                                    Balance</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/balanceSheet/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Balance
                                    Sheet</a>
                            </li>
                            <li>
                                <a href="/dashboard/generalAccounts/Reports_GeneralAccounts/incomeStatement/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Income
                                    Statement</a>
                            </li>
                        </ul>
                    ...
                    {{-- My Account --}}
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-my-account" data-collapse-toggle="dropdown-my-account">
                        ...
                        <ul id="dropdown-my-account" class="hidden py-2 space-y-2  pl-5">
                            <li>
                                {{-- <a
                                    href="/dashboard/generalAccounts/Reports_GeneralAccounts/accountsVoucher/{{ $school_code }}"
                                --}} <a href="/dashboard/generalAccounts/myAccount/currentBalance/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Current Balance</a>
                                <a href="/dashboard/generalAccounts/myAccount/personalStatement/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Personal Statement</a>
                                <a href="/dashboard/generalAccounts/myAccount/allStatement/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    All Statement</a>
                            </li>
                        </ul>
                    </li>
            ...
            {{-- Assessment --}}
            <li class="dropdown">
                <button type="button" class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-assessment" data-collapse-toggle="dropdown-assessment">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                        <path d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM8 13V15H6V13H8ZM13 13V15H11V13H13ZM18 13V15H16V13H18ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z">
                        </path>
                    </svg>
                ...
                <ul id="dropdown-assessment" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    ...
                    <li class="dropdown">
                        ...
                        <ul id="dropdown-assessment_reports" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/subjectWiseReport/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Subject Wise Report</a>
                            </li>
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/allSubjectWise/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    All Subject Wise</a>
                            </li>
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/noipunnoReport/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Noipunno
                                    Report</a>
                            </li>
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/noipunnoAllSubject/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Noipunno
                                    All Subject</a>
                            </li>
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/noipunnoMullaonPrint/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Noipunno
                                    Mullaon Print</a>
                            </li>
                            <li>
                                <a href="/dashboard/assessment/assessmentReports/noipunnoBI/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Noipunno
                                    BI</a>
                            </li>
                        </ul>
                    </li>
            ...
            <li class="dropdown hidden">
                ...
                <ul id="dropdown-student-Attendence" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                            STD Attendence</a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Leave
                            Entry Form </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                    ...
                    <li class="dropdown hidden">
                        ...
                        <ul id="dropdown-student-Reports" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            <li>
                                <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Attendence Report</a>
                            </li>
                            <li>
                                <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Attendence
                                    Blank report </a>
                            </li>
                            <li>
                                <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Date
                                    Wise Report</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Section
                                    Wise Summary</a>
                            </li>
                        </ul>
            ...
            <li class="dropdown hidden">
                ...
                <ul id="dropdown-teacher" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    ...
                    <li>
                        <a href="/dashboard/grandFinal" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Teacher
                            List</a>
                    </li>
                    <li>
                        <a href="/dashboard/tebular-format1" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Student
                            Tabulation [Format-1]</a>
                    </li>
                    <li>
                        <a href="/dashboard/tebular-format2" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Tabulation [Format-2]</a>
                    </li>
                    <li>
                        <a href="/dashboard/tebular-format3" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Tabulation [Format-3]</a>
                    </li>
                    <li>
                        <a href="/dashboard/meritList" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Merit List</a>
                    </li>
                    <li>
                        <a href="/dashboard/meritClass" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Merit List</a>
                    </li>
                    <li>
                        <a href="/dashboard/exam-failList" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            Fail List Summary</a>
                    </li>
                    <li>
                        <a href="/dashboard/unassignedSubject" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            List of Unassigned Subject</a>
                    </li>
                    <li>
                        <a href="/dashboard/passFailPercentage" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            List of Pass/Fail Percentage</a>
                    </li>
                    <li>
                        <a href="/dashboard/gradeInfo" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Upload
                            List of Grade Info</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown mb-9">
                ...
                <ul id="dropdown-basic-setting" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <!-- common setting  -->
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full p-2 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-common-setting" data-collapse-toggle="dropdown-common-setting">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                        ...
                        <ul id="dropdown-common-setting" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            ...
                            <li>
                                <a href="/dashboard/addClass/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Class</a>
                            </li>
                            <li>
                                <a href="/dashboard/addSection/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Section</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="/dashboard/addSubject/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Subject</a>
                            </li>
                            <li>
                                <a href="/dashboard/addAcademicSession/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Academic Session</a>
                            </li>
                            <li>
                                <a href="/dashboard/addAcademicYear/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Academic Year</a>
                            </li>
                            <li>
                                <a href="/dashboard/addBoardExam/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Board Exam</a>
                            </li>
                            <li>
                                <a href="/dashboard/addCategory/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Category</a>
                            </li>
                            <li>
                                <a href="/dashboard/addClassExam/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Class Exam</a>
                            </li>
                            <li>
                    ...
                    <!-- Exam Setting -->
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-slate-100/20" aria-controls="dropdown-exam-setting" data-collapse-toggle="dropdown-exam-setting">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" class="w-6 h-6">
                        ...
                        <ul id="dropdown-exam-setting" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            ...
                            <li>
                                <a href="/dashboard/addShortCode/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    Short Code</a>
                            </li>
                            <li>
                                <a href="/dashboard/setShortCode/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Set
                                    Short Code</a>
                            </li>
                            <li>
                                <a href="{{ route('get.exam.marks', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Set
                                    Exam Marks</a>
                            </li>
                            <li>
                                <a href="/dashboard/setForthSubject/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Set
                                    4th Subject</a>
                            </li>
                            <li>
                                <a href="/dashboard/AddReportName/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Add Report Name</a>
                            </li>
                            <li>
                                <a href="/dashboard/AddSignature/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">
                                    Add Signature</a>
                            </li>
                            <li>
                                <a href="/dashboard/setGradeSetup/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Grade
                                    Setup</a>
                            </li>
                            <li>
                                <a href="/dashboard/GrandFinal/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Grand
                                    Final
                                </a>
                            </li>
                            <li>
                                <a href="/dashboard/SetSignature/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Set
                                    Signature
                                </a>
                            </li>
                            <li>
                                <a href="/dashboard/ExamPublish/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Exam
                                    Publish
                                </a>
                            </li>
                            <li>
                                <a href="/dashboard/SequentialExam/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Sequential
                                    Wise Exam
                                </a>
                            </li>
                        </ul>
                    ...
                    {{-- FEES Settings --}}
                    <li class="dropdown">
                        <button type="button" class="flex items-center w-full py-2 px-4 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-fees-settings" data-collapse-toggle="dropdown-fees-settings">
                            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff">
                                <path d="M6.17071 18C6.58254 16.8348 7.69378 16 9 16C10.3062 16 11.4175 16.8348 11.8293 18H22V20H11.8293C11.4175 21.1652 10.3062 22 9 22C7.69378 22 6.58254 21.1652 6.17071 20H2V18H6.17071ZM12.1707 11C12.5825 9.83481 13.6938 9 15 9C16.3062 9 17.4175 9.83481 17.8293 11H22V13H17.8293C17.4175 14.1652 16.3062 15 15 15C13.6938 15 12.5825 14.1652 12.1707 13H2V11H12.1707ZM6.17071 4C6.58254 2.83481 7.69378 2 9 2C10.3062 2 11.4175 2.83481 11.8293 4H22V6H11.8293C11.4175 7.16519 10.3062 8 9 8C7.69378 8 6.58254 7.16519 6.17071 6H2V4H6.17071ZM9 6C9.55228 6 10 5.55228 10 5C10 4.44772 9.55228 4 9 4C8.44772 4 8 4.44772 8 5C8 5.55228 8.44772 6 9 6ZM15 13C15.5523 13 16 12.5523 16 12C16 11.4477 15.5523 11 15 11C14.4477 11 14 11.4477 14 12C14 12.5523 14.4477 13 15 13ZM9 20C9.55228 20 10 19.5523 10 19C10 18.4477 9.55228 18 9 18C8.44772 18 8 18.4477 8 19C8 19.5523 8.44772 20 9 20Z">
                                </path>
                            </svg>
                            <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white ">FEES
                                Settings</span>
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        ...
                        <ul id="dropdown-fees-settings" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/addFeeType/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    FEE TYPE</a>
                            </li>
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/feesSetup/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">FEES
                                    Setup</a>
                            </li>
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/addPaySlipType/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">Add
                                    PAY SLIP TYPE</a>
                            </li>
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/paySlipSetup/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">PAY
                                    SLIP Setup</a>
                            </li>
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/waiverType/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">WAIVER
                                    Type</a>
                            </li>
                            <li>
                                <a href="/dashboard/basicSettings/feesSettings/waiverSetup/{{ $school_code }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">WAIVER
                                    Setup</a>
                            </li>
                            {{-- Reports (FEES Settings) --}}
                            <li class="dropdown">
                                <button type="button" class="flex items-center w-full p-2 pl-7 text-base text-gray-900 transition duration-75 rounded-lg group " aria-controls="dropdown-reports-fees-settings" data-collapse-toggle="dropdown-reports-fees-settings">
                                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white ">Reports
                                        (FEES Settings)</span>
                                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                        <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                                ...
                                <ul id="dropdown-reports-fees-settings" class="hidden py-2 space-y-2 pl-5">
                                    <li>
                                        <a href="{{ route('allFeesReport.view', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">ALL
                                            FEES</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('allPaySlipReport.view', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">ALL
                                            PAY SLIP</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('individualPaySlipReport.view', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">INDIVIDUAL
                                            PAY SLIP</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('individualWaiverReport.view', $school_code) }}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">INDIVIDUAL
                                            WAIVER</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <li class="dropdown ">
                <button class="flex items-center w-full py-2 px-4 text-base text-gray-900 transition duration-75 rounded-lg group cursor-pointer hover:bg-slate-100/20" aria-controls="dropdown-machine-attendance" data-collapse-toggle="dropdown-machine-attendance">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                    </svg>

                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap text-white ">Machine Attendence</span>
                ...
                <ul id="dropdown-machine-attendance" class="hidden py-2 space-y-1 border-s ms-7 border-dashed px-3">
                    <li>
                        <a href="{{route('std.time.setting',$school_code)}}" class="flex items-center w-full p-2 text-white  transition duration-75 rounded-lg pl-5 group  hover:bg-slate-100/20">STD Time Settings</a>
                    </li>
                    <li>
